 ...
 */
public class WebAPI extends Authentication {
    private static final long serialVersionUID = 1L;

    /** http://www.m0ep.de/sioc-service-auth#WebAPI */
     ...
     */
    protected WebAPI(Model model, URI classURI,
     ...
     */
    public WebAPI(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static WebAPI getInstance(Model model,
     ...
     */
    public static ReactorResult<? extends WebAPI> getAllInstances_as(Model model) {
	return Base.getAllInstances_as(model, RDFS_CLASS, WebAPI.class);
    }

    /**
     * Remove rdf:type WebAPI from this instance. Other triples are not
