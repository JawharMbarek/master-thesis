 ...
 */
public class Append extends Write {
    private static final long serialVersionUID = -4841747567341225462L;

    /** http://www.w3.org/ns/auth/acl#Append */
    public static final URI RDFS_CLASS = new URIImpl(
	    "http://www.w3.org/ns/auth/acl#Append", false);
     ...
     */
    protected Append(Model model, URI classURI,
     ...
     */
    public Append(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public Append(Model model, BlankNode bnode, boolean write) {
     ...
     */
    public Append(Model model, boolean write) {
     ...
     *            an RDF2Go resource
     * @return an instance of Append or null if none existst
     * 
     *         [Generated from RDFReactor template rule #class0]
     */
    public static Append getInstance(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	return Base.getInstance(model, instanceResource, Append.class);
    }
     ...
     */
    public static ReactorResult<? extends Append> getAllInstances_as(Model model) {
	return Base.getAllInstances_as(model, RDFS_CLASS, Append.class);
    }

    /**
     * Remove rdf:type Append from this instance. Other triples are not
