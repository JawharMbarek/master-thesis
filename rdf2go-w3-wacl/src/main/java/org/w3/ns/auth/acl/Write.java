...
public class Write extends Access {
    private static final long serialVersionUID = 7328011682173566824L;

    /** http://www.w3.org/ns/auth/acl#Write */
    public static final URI RDFS_CLASS = new URIImpl(
	    "http://www.w3.org/ns/auth/acl#Write", false);
     ...
     */
    protected Write(Model model, URI classURI,
     ...
     */
    public Write(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public Write(Model model, BlankNode bnode, boolean write) {
     ...
     */
    public Write(Model model, boolean write) {
     ...
     *            an RDF2Go resource
     * @return an instance of Write or null if none existst
     * 
     *         [Generated from RDFReactor template rule #class0]
     */
    public static Write getInstance(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	return Base.getInstance(model, instanceResource, Write.class);
    }
     ...
     */
    public static ReactorResult<? extends Write> getAllInstances_as(Model model) {
	return Base.getAllInstances_as(model, RDFS_CLASS, Write.class);
    }

    /**
     * Remove rdf:type Write from this instance. Other triples are not affected.
