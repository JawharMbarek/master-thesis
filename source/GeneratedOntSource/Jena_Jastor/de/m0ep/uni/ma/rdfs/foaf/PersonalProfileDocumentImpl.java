...
/**
 * Implementation of {@link de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocument}
 ...
 * <br>
 */
public class PersonalProfileDocumentImpl extends com.ibm.adtech.jastor.ThingImpl implements de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocument {
	...
	PersonalProfileDocumentImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static PersonalProfileDocumentImpl getPersonalProfileDocument(Resource resource, Model model) throws JastorException {
		return new PersonalProfileDocumentImpl(resource, model);
	}
	    
	static PersonalProfileDocumentImpl createPersonalProfileDocument(Resource resource, Model model) throws JastorException { 
		PersonalProfileDocumentImpl impl = new PersonalProfileDocumentImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, PersonalProfileDocument.TYPE)))
			impl._model.add(impl._resource, RDF.type, PersonalProfileDocument.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocument.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initFundedBy() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/fundedBy properties in PersonalProfileDocument model not a Resource", stmt.getObject());
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/name properties in PersonalProfileDocument model not a Literal", stmt.getObject());
	...
	public com.ibm.adtech.jastor.Thing getPrimaryTopic() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
			throw new JastorInvalidRDFNodeException(uri() + ": primaryTopic getProperty() in de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocument model not Resource", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	private void initDnaChecksum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/dnaChecksum properties in PersonalProfileDocument model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initPhone() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/phone properties in PersonalProfileDocument model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPage() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/page properties in PersonalProfileDocument model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initNick() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/nick properties in PersonalProfileDocument model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			nick.add(literal);
		}
	}
	...
	private void initLogo() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/logo properties in PersonalProfileDocument model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initMaker() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/maker properties in PersonalProfileDocument model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initGivenname() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/givenname properties in PersonalProfileDocument model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initTopic() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/topic properties in PersonalProfileDocument model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initTitle() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/title properties in PersonalProfileDocument model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			title.add(literal);
		}
	}
	...
	private void initHomepage() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/homepage properties in PersonalProfileDocument model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initSha1() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/sha1 properties in PersonalProfileDocument model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			sha1.add(literal);
		}
	}
	...
	private void initTheme() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/theme properties in PersonalProfileDocument model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof PersonalProfileDocumentListener))
			throw new IllegalArgumentException("ThingListener must be instance of PersonalProfileDocumentListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((PersonalProfileDocumentListener)listener);
		}
	}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFundedBy.iterator();iter.hasNext();){
							PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
							listener.fundedByAdded(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,_fundedBy);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
						listener.nameAdded(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(primaryTopicProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
						listener.primaryTopicChanged(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(dnaChecksumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDnaChecksum.iterator();iter.hasNext();){
						PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
						listener.dnaChecksumAdded(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPhone.iterator();iter.hasNext();){
							PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
							listener.phoneAdded(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,_phone);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPage.iterator();iter.hasNext();){
							PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
							listener.pageAdded(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,_page);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nickProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNick.iterator();iter.hasNext();){
						PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
						listener.nickAdded(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLogo.iterator();iter.hasNext();){
							PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
							listener.logoAdded(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,_logo);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMaker.iterator();iter.hasNext();){
							PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
							listener.makerAdded(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,_maker);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(givennameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForGivenname.iterator();iter.hasNext();){
						PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
						listener.givennameAdded(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
							listener.topicAdded(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,_topic);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
						listener.titleAdded(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomepage.iterator();iter.hasNext();){
							PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
							listener.homepageAdded(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,_homepage);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(sha1Property)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForSha1.iterator();iter.hasNext();){
						PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
						listener.sha1Added(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTheme.iterator();iter.hasNext();){
							PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
							listener.themeAdded(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,_theme);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(fundedByProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFundedBy.iterator();iter.hasNext();){
							PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
							listener.fundedByRemoved(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,_fundedBy);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
						listener.nameRemoved(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,literal);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(dnaChecksumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDnaChecksum.iterator();iter.hasNext();){
						PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
						listener.dnaChecksumRemoved(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(phoneProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPhone.iterator();iter.hasNext();){
							PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
							listener.phoneRemoved(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,_phone);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(pageProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPage.iterator();iter.hasNext();){
							PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
							listener.pageRemoved(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,_page);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nickProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNick.iterator();iter.hasNext();){
						PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
						listener.nickRemoved(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(logoProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLogo.iterator();iter.hasNext();){
							PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
							listener.logoRemoved(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,_logo);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(makerProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMaker.iterator();iter.hasNext();){
							PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
							listener.makerRemoved(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,_maker);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(givennameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForGivenname.iterator();iter.hasNext();){
						PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
						listener.givennameRemoved(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(topicProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
							listener.topicRemoved(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,_topic);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
						listener.titleRemoved(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,literal);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(homepageProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomepage.iterator();iter.hasNext();){
							PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
							listener.homepageRemoved(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,_homepage);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(sha1Property)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForSha1.iterator();iter.hasNext();){
						PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
						listener.sha1Removed(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(themeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTheme.iterator();iter.hasNext();){
							PersonalProfileDocumentListener listener=(PersonalProfileDocumentListener)iter.next();
							listener.themeRemoved(de.m0ep.uni.ma.rdfs.foaf.PersonalProfileDocumentImpl.this,_theme);
						}
					}
				}
				return;
