...
/**
 * Interface for Site@en ontology class<br>
 ...
 * 	label : Site@en <br>
 * 	comment : A Site can be the location of an online community or set of communities, with UserAccounts and Usergroups creating Items in a set of Containers. It can be thought of as a web-accessible data Space.@en <br>
 * <br>
 * <br>
 */
public interface Site extends de.m0ep.uni.ma.rdfs.sioc.Space, com.ibm.adtech.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final Resource TYPE = ResourceFactory.createResource("http://rdfs.org/sioc/ns#Site");
	

	/**
	 * The Jena Property for has__administrator 
	 * <p>(URI: http://rdfs.org/sioc/ns#has_administrator)</p>
	 * <br>
	 * <br>
	 * RDF Schema Standard Properties <br>
	 * 	isDefinedBy : http://rdfs.org/sioc/ns# <br>
	 * 	label : has administrator@en <br>
	 * 	comment : A UserAccount that is an administrator of this Site.@en <br>
	 * <br>  
	 */
	public static com.hp.hpl.jena.rdf.model.Property has__administratorProperty = ResourceFactory.createProperty("http://rdfs.org/sioc/ns#has_administrator");


	/**
	 * The Jena Property for host__of 
	 * <p>(URI: http://rdfs.org/sioc/ns#host_of)</p>
	 * <br>
	 * <br>
	 * RDF Schema Standard Properties <br>
	 * 	isDefinedBy : http://rdfs.org/sioc/ns# <br>
	 * 	label : host of@en <br>
	 * 	comment : A Forum that is hosted on this Site.@en <br>
	 * <br>  
	 */
	public static com.hp.hpl.jena.rdf.model.Property host__ofProperty = ResourceFactory.createProperty("http://rdfs.org/sioc/ns#host_of");
	...
	/**
	 * Get an Iterator the 'has__administrator' property values.  This Iteartor
	 * may be used to remove all such values.
	 * @return		{@link java.util.Iterator} of {@link de.m0ep.uni.ma.rdfs.sioc.UserAccount}
	 * @see			#has__administratorProperty
	 */
	public java.util.Iterator getHas__administrator() throws com.ibm.adtech.jastor.JastorException;

	/**
	 * Adds a value for the 'has__administrator' property
	 * @param		The {@link de.m0ep.uni.ma.rdfs.sioc.UserAccount} to add
	 * @see			#has__administratorProperty
	 */
	public void addHas__administrator(de.m0ep.uni.ma.rdfs.sioc.UserAccount has__administrator) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Adds an anonymous value for the 'has__administrator' property
	 * @return		The anoymous {@link de.m0ep.uni.ma.rdfs.sioc.UserAccount} created
	 * @see			#has__administratorProperty
	 */
	public de.m0ep.uni.ma.rdfs.sioc.UserAccount addHas__administrator() throws com.ibm.adtech.jastor.JastorException;
	 ...
	 * @see			#has__administratorProperty
	 */
	public de.m0ep.uni.ma.rdfs.sioc.UserAccount addHas__administrator(com.hp.hpl.jena.rdf.model.Resource resource) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Removes a value for the 'has__administrator' property.  This method should not
	 * be invoked while iterator through values.  In that case, the remove() method of the Iterator
	 * itself should be used.
	 * @param		The {@link de.m0ep.uni.ma.rdfs.sioc.UserAccount} to remove
	 * @see			#has__administratorProperty
	 */
	public void removeHas__administrator(de.m0ep.uni.ma.rdfs.sioc.UserAccount has__administrator) throws com.ibm.adtech.jastor.JastorException;
		
	/**
	 * Get an Iterator the 'host__of' property values.  This Iteartor
	 * may be used to remove all such values.
	 * @return		{@link java.util.Iterator} of {@link de.m0ep.uni.ma.rdfs.sioc.Forum}
	 * @see			#host__ofProperty
	 */
	public java.util.Iterator getHost__of() throws com.ibm.adtech.jastor.JastorException;

	/**
	 * Adds a value for the 'host__of' property
	 * @param		The {@link de.m0ep.uni.ma.rdfs.sioc.Forum} to add
	 * @see			#host__ofProperty
	 */
	public void addHost__of(de.m0ep.uni.ma.rdfs.sioc.Forum host__of) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Adds an anonymous value for the 'host__of' property
	 * @return		The anoymous {@link de.m0ep.uni.ma.rdfs.sioc.Forum} created
	 * @see			#host__ofProperty
	 */
	public de.m0ep.uni.ma.rdfs.sioc.Forum addHost__of() throws com.ibm.adtech.jastor.JastorException;
	 ...
	 * @see			#host__ofProperty
	 */
	public de.m0ep.uni.ma.rdfs.sioc.Forum addHost__of(com.hp.hpl.jena.rdf.model.Resource resource) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Removes a value for the 'host__of' property.  This method should not
	 * be invoked while iterator through values.  In that case, the remove() method of the Iterator
	 * itself should be used.
	 * @param		The {@link de.m0ep.uni.ma.rdfs.sioc.Forum} to remove
	 * @see			#host__ofProperty
	 */
	public void removeHost__of(de.m0ep.uni.ma.rdfs.sioc.Forum host__of) throws com.ibm.adtech.jastor.JastorException;
