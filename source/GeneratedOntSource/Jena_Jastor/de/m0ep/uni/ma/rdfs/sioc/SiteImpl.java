...
/**
 * Implementation of {@link de.m0ep.uni.ma.rdfs.sioc.Site}
 * Use the de.m0ep.uni.ma.rdfs.sioc.Factory to create instances of this class.
 * <p>(URI: http://rdfs.org/sioc/ns#Site)</p>
 * <br>
 */
public class SiteImpl extends com.ibm.adtech.jastor.ThingImpl implements de.m0ep.uni.ma.rdfs.sioc.Site {
	...
	void addSuperTypes() {
		if (!_model.contains(_resource, RDF.type, de.m0ep.uni.ma.rdfs.sioc.Space.TYPE))
			_model.add(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(_resource, RDF.type, de.m0ep.uni.ma.rdfs.sioc.Space.TYPE));     
	}
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, de.m0ep.uni.ma.rdfs.sioc.Site.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initHas__administrator() throws JastorException {
		...
		while(it.hasNext()) {
			...
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				de.m0ep.uni.ma.rdfs.sioc.UserAccount has__administrator = de.m0ep.uni.ma.rdfs.sioc.Factory.getUserAccount(resource,_model);
	...
	public void addHas__administrator(de.m0ep.uni.ma.rdfs.sioc.UserAccount has__administrator) throws JastorException {
	...
	public de.m0ep.uni.ma.rdfs.sioc.UserAccount addHas__administrator() throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.UserAccount has__administrator = de.m0ep.uni.ma.rdfs.sioc.Factory.createUserAccount(_model.createResource(),_model);
		if (this.has__administrator == null)
			initHas__administrator();
		this.has__administrator.add(has__administrator);
		_model.add(_model.createStatement(_resource,has__administratorProperty,has__administrator.resource()));
	...
	public de.m0ep.uni.ma.rdfs.sioc.UserAccount addHas__administrator(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.UserAccount has__administrator = de.m0ep.uni.ma.rdfs.sioc.Factory.getUserAccount(resource,_model);
		if (this.has__administrator == null)
			initHas__administrator();
		if (this.has__administrator.contains(has__administrator))
	...
	public void removeHas__administrator(de.m0ep.uni.ma.rdfs.sioc.UserAccount has__administrator) throws JastorException {
		if (this.has__administrator == null)
			initHas__administrator();
		if (!this.has__administrator.contains(has__administrator))
			return;
	...
	private void initHost__of() throws JastorException {
		...
		while(it.hasNext()) {
			...
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				de.m0ep.uni.ma.rdfs.sioc.Forum host__of = de.m0ep.uni.ma.rdfs.sioc.Factory.getForum(resource,_model);
	...
	public void addHost__of(de.m0ep.uni.ma.rdfs.sioc.Forum host__of) throws JastorException {
	...
	public de.m0ep.uni.ma.rdfs.sioc.Forum addHost__of() throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.Forum host__of = de.m0ep.uni.ma.rdfs.sioc.Factory.createForum(_model.createResource(),_model);
		if (this.host__of == null)
			initHost__of();
		this.host__of.add(host__of);
		_model.add(_model.createStatement(_resource,host__ofProperty,host__of.resource()));
	...
	public de.m0ep.uni.ma.rdfs.sioc.Forum addHost__of(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.Forum host__of = de.m0ep.uni.ma.rdfs.sioc.Factory.getForum(resource,_model);
		if (this.host__of == null)
			initHost__of();
		if (this.host__of.contains(host__of))
	...
	public void removeHost__of(de.m0ep.uni.ma.rdfs.sioc.Forum host__of) throws JastorException {
		if (this.host__of == null)
			initHost__of();
		if (!this.host__of.contains(host__of))
			return;
	...
	public void unregisterListener(ThingListener listener) {
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLink.iterator();iter.hasNext();){
							...
							listener.linkAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_link);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(noteProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNote.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.noteAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__creator.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.has__creatorAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_has__creator);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__owner.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.has__ownerAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_has__owner);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDescription.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.descriptionAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubject.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.subjectAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_subject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__authorsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__authors.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.num__authorsAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__viewsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__views.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.num__viewsAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReferences.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.referencesAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_references);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.topicAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_topic);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__activity__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__activity__date.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.last__activity__dateAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(idProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForId.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.idAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLinks__to.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.links__toAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_links__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__usergroup.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.has__usergroupAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_has__usergroup);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__reply__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__reply__date.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.last__reply__dateAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__repliesProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__replies.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.num__repliesAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__function.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.has__functionAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_has__function);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSpace__of.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.space__ofAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_space__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.nameAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__space.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.has__spaceAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_has__space);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRelated__to.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.related__toAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_related__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDate.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.dateAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.titleAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForScope__of.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.scope__ofAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_scope__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeed.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.feedAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_feed);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.depictionAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_depiction);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__administratorProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					de.m0ep.uni.ma.rdfs.sioc.UserAccount _has__administrator = null;
					try {
						_has__administrator = de.m0ep.uni.ma.rdfs.sioc.Factory.getUserAccount(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__administrator == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__administrator.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.has__administratorAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_has__administrator);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(host__ofProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					de.m0ep.uni.ma.rdfs.sioc.Forum _host__of = null;
					try {
						_host__of = de.m0ep.uni.ma.rdfs.sioc.Factory.getForum(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (host__of == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHost__of.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.host__ofAdded(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_host__of);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(linkProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLink.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.linkRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_link);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(noteProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNote.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.noteRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__creatorProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__creator.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.has__creatorRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_has__creator);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ownerProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__owner.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.has__ownerRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_has__owner);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDescription.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.descriptionRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(subjectProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubject.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.subjectRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_subject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__authorsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.num__authorsRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__viewsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.num__viewsRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(referencesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReferences.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.referencesRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_references);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(topicProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.topicRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_topic);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__activity__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__activity__date.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.last__activity__dateRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(idProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForId.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.idRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(links__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLinks__to.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.links__toRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_links__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__usergroupProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__usergroup.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.has__usergroupRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_has__usergroup);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__reply__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__reply__date.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.last__reply__dateRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__repliesProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.num__repliesRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__functionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__function.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.has__functionRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_has__function);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(space__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSpace__of.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.space__ofRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_space__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.nameRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__spaceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__space.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.has__spaceRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_has__space);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(related__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRelated__to.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.related__toRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_related__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDate.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.dateRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						SiteListener listener=(SiteListener)iter.next();
						listener.titleRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(scope__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForScope__of.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.scope__ofRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_scope__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(feedProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeed.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.feedRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_feed);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(depictionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.depictionRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_depiction);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__administrator != null) {
						...
						for (int i=0;i<has__administrator.size();i++) {
							de.m0ep.uni.ma.rdfs.sioc.UserAccount __item = (de.m0ep.uni.ma.rdfs.sioc.UserAccount) has__administrator.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__administrator.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.has__administratorRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_has__administrator);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (host__of != null) {
						...
						for (int i=0;i<host__of.size();i++) {
							de.m0ep.uni.ma.rdfs.sioc.Forum __item = (de.m0ep.uni.ma.rdfs.sioc.Forum) host__of.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_host__of = __item;
								break;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHost__of.iterator();iter.hasNext();){
							SiteListener listener=(SiteListener)iter.next();
							listener.host__ofRemoved(de.m0ep.uni.ma.rdfs.sioc.SiteImpl.this,_host__of);
						}
					}
				}
				return;
