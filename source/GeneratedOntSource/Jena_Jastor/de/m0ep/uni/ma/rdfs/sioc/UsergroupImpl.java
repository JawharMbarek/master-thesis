...
/**
 * Implementation of {@link de.m0ep.uni.ma.rdfs.sioc.Usergroup}
 * Use the de.m0ep.uni.ma.rdfs.sioc.Factory to create instances of this class.
 * <p>(URI: http://rdfs.org/sioc/ns#Usergroup)</p>
 * <br>
 */
public class UsergroupImpl extends com.ibm.adtech.jastor.ThingImpl implements de.m0ep.uni.ma.rdfs.sioc.Usergroup {
	...
	private static com.hp.hpl.jena.rdf.model.Property usergroup__ofProperty = ResourceFactory.createProperty("http://rdfs.org/sioc/ns#usergroup_of");
	private java.util.ArrayList usergroup__of;
	...
	private static com.hp.hpl.jena.rdf.model.Property has__memberProperty = ResourceFactory.createProperty("http://rdfs.org/sioc/ns#has_member");
	private java.util.ArrayList has__member;
	...
	UsergroupImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static UsergroupImpl getUsergroup(Resource resource, Model model) throws JastorException {
		return new UsergroupImpl(resource, model);
	}
	    
	static UsergroupImpl createUsergroup(Resource resource, Model model) throws JastorException { 
		UsergroupImpl impl = new UsergroupImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, Usergroup.TYPE)))
			impl._model.add(impl._resource, RDF.type, Usergroup.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,usergroup__ofProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		...
		it = _model.listStatements(_resource,has__memberProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		...
		it = _model.listStatements(_resource,RDF.type, de.m0ep.uni.ma.rdfs.sioc.Usergroup.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	private void initLink() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#link properties in Usergroup model not a Resource", stmt.getObject());
	...
	private void initNote() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#note properties in Usergroup model not a Literal", stmt.getObject());
	...
	private void initHas__creator() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_creator properties in Usergroup model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__owner() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_owner properties in Usergroup model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initDescription() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/description properties in Usergroup model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initUsergroup__of() throws JastorException {
		this.usergroup__of = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, usergroup__ofProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#usergroup_of properties in Usergroup model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				de.m0ep.uni.ma.rdfs.sioc.Space usergroup__of = de.m0ep.uni.ma.rdfs.sioc.Factory.getSpace(resource,_model);
				this.usergroup__of.add(usergroup__of);
			}
		}
	}

	public java.util.Iterator getUsergroup__of() throws JastorException {
		if (usergroup__of == null)
			initUsergroup__of();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(usergroup__of,_resource,usergroup__ofProperty,true);
	}

	public void addUsergroup__of(de.m0ep.uni.ma.rdfs.sioc.Space usergroup__of) throws JastorException {
		if (this.usergroup__of == null)
			initUsergroup__of();
		if (this.usergroup__of.contains(usergroup__of)) {
			this.usergroup__of.remove(usergroup__of);
			this.usergroup__of.add(usergroup__of);
			return;
		}
		this.usergroup__of.add(usergroup__of);
		_model.add(_model.createStatement(_resource,usergroup__ofProperty,usergroup__of.resource()));
	}
	
	public de.m0ep.uni.ma.rdfs.sioc.Space addUsergroup__of() throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.Space usergroup__of = de.m0ep.uni.ma.rdfs.sioc.Factory.createSpace(_model.createResource(),_model);
		if (this.usergroup__of == null)
			initUsergroup__of();
		this.usergroup__of.add(usergroup__of);
		_model.add(_model.createStatement(_resource,usergroup__ofProperty,usergroup__of.resource()));
		return usergroup__of;
	}
	
	public de.m0ep.uni.ma.rdfs.sioc.Space addUsergroup__of(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.Space usergroup__of = de.m0ep.uni.ma.rdfs.sioc.Factory.getSpace(resource,_model);
		if (this.usergroup__of == null)
			initUsergroup__of();
		if (this.usergroup__of.contains(usergroup__of))
	...
	public void removeUsergroup__of(de.m0ep.uni.ma.rdfs.sioc.Space usergroup__of) throws JastorException {
		if (this.usergroup__of == null)
			initUsergroup__of();
		if (!this.usergroup__of.contains(usergroup__of))
			return;
		if (!_model.contains(_resource, usergroup__ofProperty, usergroup__of.resource()))
			return;
		this.usergroup__of.remove(usergroup__of);
		_model.removeAll(_resource, usergroup__ofProperty, usergroup__of.resource());
	}
	...
	private void initSubject() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/subject properties in Usergroup model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initNum__authors() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#num_authors properties in Usergroup model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initNum__views() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#num_views properties in Usergroup model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.String","http://www.w3.org/2001/XMLSchema#nonNegativeInteger");
			if (obj != null)
				num__views.add(obj);
	...
	private void initReferences() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/references properties in Usergroup model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initTopic() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#topic properties in Usergroup model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initLast__activity__date() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#last_activity_date properties in Usergroup model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initId() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#id properties in Usergroup model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			id.add(literal);
		}
	}
	...
	private void initLinks__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#links_to properties in Usergroup model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initLast__reply__date() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#last_reply_date properties in Usergroup model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initNum__replies() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#num_replies properties in Usergroup model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.String","http://www.w3.org/2001/XMLSchema#nonNegativeInteger");
			if (obj != null)
	...
	private void initHas__function() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_function properties in Usergroup model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#name properties in Usergroup model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			name.add(literal);
		}
	}
	...
	private void initHas__space() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_space properties in Usergroup model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initRelated__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#related_to properties in Usergroup model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initDate() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/date properties in Usergroup model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			date.add(literal);
		}
	}
	...
	private void initTitle() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/title properties in Usergroup model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			title.add(literal);
		}
	}
	...
	private void initHas__member() throws JastorException {
		this.has__member = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__memberProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_member properties in Usergroup model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				de.m0ep.uni.ma.rdfs.sioc.UserAccount has__member = de.m0ep.uni.ma.rdfs.sioc.Factory.getUserAccount(resource,_model);
				this.has__member.add(has__member);
			}
		}
	}

	public java.util.Iterator getHas__member() throws JastorException {
		if (has__member == null)
			initHas__member();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__member,_resource,has__memberProperty,true);
	}

	public void addHas__member(de.m0ep.uni.ma.rdfs.sioc.UserAccount has__member) throws JastorException {
		if (this.has__member == null)
			initHas__member();
		if (this.has__member.contains(has__member)) {
			this.has__member.remove(has__member);
			this.has__member.add(has__member);
			return;
		}
		this.has__member.add(has__member);
		_model.add(_model.createStatement(_resource,has__memberProperty,has__member.resource()));
	}
	
	public de.m0ep.uni.ma.rdfs.sioc.UserAccount addHas__member() throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.UserAccount has__member = de.m0ep.uni.ma.rdfs.sioc.Factory.createUserAccount(_model.createResource(),_model);
		if (this.has__member == null)
			initHas__member();
		this.has__member.add(has__member);
		_model.add(_model.createStatement(_resource,has__memberProperty,has__member.resource()));
	...
	public de.m0ep.uni.ma.rdfs.sioc.UserAccount addHas__member(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.UserAccount has__member = de.m0ep.uni.ma.rdfs.sioc.Factory.getUserAccount(resource,_model);
		if (this.has__member == null)
			initHas__member();
		if (this.has__member.contains(has__member))
	...
	public void removeHas__member(de.m0ep.uni.ma.rdfs.sioc.UserAccount has__member) throws JastorException {
		if (this.has__member == null)
			initHas__member();
		if (!this.has__member.contains(has__member))
			return;
		if (!_model.contains(_resource, has__memberProperty, has__member.resource()))
			return;
		this.has__member.remove(has__member);
		_model.removeAll(_resource, has__memberProperty, has__member.resource());
	}
	...
	private void initScope__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#scope_of properties in Usergroup model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initFeed() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#feed properties in Usergroup model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initDepiction() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/depiction properties in Usergroup model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof UsergroupListener))
			throw new IllegalArgumentException("ThingListener must be instance of UsergroupListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((UsergroupListener)listener);
		}
	}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLink.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.linkAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_link);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(noteProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNote.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.noteAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__creator.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__creatorAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_has__creator);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__owner.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__ownerAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_has__owner);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDescription.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.descriptionAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(usergroup__ofProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					de.m0ep.uni.ma.rdfs.sioc.Space _usergroup__of = null;
					try {
						_usergroup__of = de.m0ep.uni.ma.rdfs.sioc.Factory.getSpace(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (usergroup__of == null) {
					...
					if (!usergroup__of.contains(_usergroup__of))
						usergroup__of.add(_usergroup__of);
					if (listeners != null) {
						java.util.ArrayList consumersForUsergroup__of;
						synchronized (listeners) {
							consumersForUsergroup__of = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForUsergroup__of.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.usergroup__ofAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_usergroup__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubject.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.subjectAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_subject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__authorsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__authors.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.num__authorsAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__viewsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__views.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.num__viewsAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReferences.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.referencesAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_references);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.topicAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_topic);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__activity__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__activity__date.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.last__activity__dateAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(idProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForId.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.idAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLinks__to.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.links__toAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_links__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__reply__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__reply__date.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.last__reply__dateAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__repliesProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__replies.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.num__repliesAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__function.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__functionAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_has__function);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.nameAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__space.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__spaceAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_has__space);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRelated__to.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.related__toAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_related__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDate.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.dateAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.titleAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__memberProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					de.m0ep.uni.ma.rdfs.sioc.UserAccount _has__member = null;
					try {
						_has__member = de.m0ep.uni.ma.rdfs.sioc.Factory.getUserAccount(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__member == null) {
					...
					if (!has__member.contains(_has__member))
						has__member.add(_has__member);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__member;
						synchronized (listeners) {
							consumersForHas__member = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__member.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__memberAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_has__member);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForScope__of.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.scope__ofAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_scope__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeed.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.feedAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_feed);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.depictionAdded(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_depiction);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(linkProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLink.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.linkRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_link);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(noteProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNote.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.noteRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__creatorProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__creator.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__creatorRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_has__creator);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ownerProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__owner.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__ownerRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_has__owner);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDescription.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.descriptionRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(usergroup__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (usergroup__of != null) {
						boolean found = false;
						for (int i=0;i<usergroup__of.size();i++) {
							de.m0ep.uni.ma.rdfs.sioc.Space __item = (de.m0ep.uni.ma.rdfs.sioc.Space) usergroup__of.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_usergroup__of = __item;
								break;
							}
						}
						if (found)
							usergroup__of.remove(_usergroup__of);
						else {
							try {
								_usergroup__of = de.m0ep.uni.ma.rdfs.sioc.Factory.getSpace(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForUsergroup__of.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.usergroup__ofRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_usergroup__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(subjectProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubject.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.subjectRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_subject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__authorsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.num__authorsRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__viewsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.num__viewsRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(referencesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReferences.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.referencesRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_references);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(topicProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.topicRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_topic);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__activity__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__activity__date.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.last__activity__dateRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(idProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForId.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.idRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(links__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLinks__to.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.links__toRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_links__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__reply__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__reply__date.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.last__reply__dateRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__repliesProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.num__repliesRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__functionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__function.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__functionRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_has__function);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.nameRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__spaceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__space.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__spaceRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_has__space);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(related__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRelated__to.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.related__toRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_related__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDate.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.dateRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.titleRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__memberProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__member != null) {
						boolean found = false;
						for (int i=0;i<has__member.size();i++) {
							de.m0ep.uni.ma.rdfs.sioc.UserAccount __item = (de.m0ep.uni.ma.rdfs.sioc.UserAccount) has__member.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__member = __item;
								break;
						...
						if (found)
							has__member.remove(_has__member);
						else {
							try {
								_has__member = de.m0ep.uni.ma.rdfs.sioc.Factory.getUserAccount(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__member.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__memberRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_has__member);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(scope__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForScope__of.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.scope__ofRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_scope__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(feedProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeed.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.feedRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_feed);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(depictionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.depictionRemoved(de.m0ep.uni.ma.rdfs.sioc.UsergroupImpl.this,_depiction);
						}
					}
				}
				return;
