...
public class SIOC {
     ...
     *  is addressed to.</p>
     */
    public static final ObjectProperty addressed_to = m_model.createObjectProperty( "http://rdfs.org/sioc/ns#addressed_to" );
    ...
    public static final ObjectProperty embeds_knowledge = m_model.createObjectProperty( "http://rdfs.org/sioc/ns#embeds_knowledge" );
     ...
     */
    public static final DatatypeProperty last_activity_date = m_model.createDatatypeProperty( "http://rdfs.org/sioc/ns#last_activity_date" );
    
    /** <p>The date and time of the last Post (or Item) in a Forum (or a Container), 
     *  in ISO 8601 format.</p>
     */
    public static final DatatypeProperty last_item_date = m_model.createDatatypeProperty( "http://rdfs.org/sioc/ns#last_item_date" );
     ...
     */
    public static final DatatypeProperty last_reply_date = m_model.createDatatypeProperty( "http://rdfs.org/sioc/ns#last_reply_date" );
     ...
     */
    public static final DatatypeProperty num_authors = m_model.createDatatypeProperty( "http://rdfs.org/sioc/ns#num_authors" );
    
    /** <p>The number of Posts (or Items) in a Forum (or a Container).</p> */
    public static final DatatypeProperty num_items = m_model.createDatatypeProperty( "http://rdfs.org/sioc/ns#num_items" );
    ...
    public static final DatatypeProperty num_threads = m_model.createDatatypeProperty( "http://rdfs.org/sioc/ns#num_threads" );
    ...
    public static final OntClass UserAccount = m_model.createClass( "http://rdfs.org/sioc/ns#UserAccount" );
