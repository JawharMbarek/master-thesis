 ...
 */
public class Thread extends Container {

    /** http://rdfs.org/sioc/ns#Thread */
	@SuppressWarnings("hiding")
	public static final URI RDFS_CLASS = new URIImpl("http://rdfs.org/sioc/ns#Thread", false);
	 ...
	 */
	protected Thread ( Model model, URI classURI, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public Thread ( Model model, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public Thread ( Model model, String uriString, boolean write) throws ModelRuntimeException {
	 ...
	 */
	public Thread ( Model model, BlankNode bnode, boolean write ) {
	 ...
	 */
	public Thread ( Model model, boolean write ) {
	 ...
	 * @return an instance of Thread  or null if none existst
	 *
	 * [Generated from RDFReactor template rule #class0] 
	 */
	public static Thread  getInstance(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getInstance(model, instanceResource, Thread.class);
	}

	/**
	 * Create a new instance of this class in the model. 
	 * That is, create the statement (instanceResource, RDF.type, http://rdfs.org/sioc/ns#Thread).
	 * @param model an RDF2Go model
	 * @param instanceResource an RDF2Go resource
	 *
	 ...
	 */
	public static ReactorResult<? extends Thread> getAllInstances_as(Model model) {
		return Base.getAllInstances_as(model, RDFS_CLASS, Thread.class );
	}

    /**
	 * Remove rdf:type Thread from this instance. Other triples are not affected.
