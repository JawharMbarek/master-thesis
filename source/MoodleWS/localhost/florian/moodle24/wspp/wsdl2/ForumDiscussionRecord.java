...
public class ForumDiscussionRecord  extends SoapObject  implements Soapeabilisable{
    ...
    private localhost.florian.moodle24.wspp.wsdl2.ForumPostRecord post;
    ...
    public Soapeabilisable fromSoapResponse (SoapObject response) {
      ...
      ret.setName(KSoap2Utils.getString(response,"name") );
       localhost.florian.moodle24.wspp.wsdl2.ForumPostRecord _post= (localhost.florian.moodle24.wspp.wsdl2.ForumPostRecord) (KSoap2Utils.getObject((SoapObject) response.getProperty("post"), new localhost.florian.moodle24.wspp.wsdl2.ForumPostRecord(this.namespace)));
       ret.setPost(_post);
     ...
     * @return post
     */
    public localhost.florian.moodle24.wspp.wsdl2.ForumPostRecord getPost() {
        return post;
    }
     ...
     * @param post
     */
    public void setPost(localhost.florian.moodle24.wspp.wsdl2.ForumPostRecord post) {
        this.post = post;
