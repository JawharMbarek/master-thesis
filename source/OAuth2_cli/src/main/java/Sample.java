...
public class Sample {
  ...
  private static void setupTransport() throws IOException {
    ...
    unauthenticatedPlus = builder.setJsonHttpRequestInitializer(new JsonHttpRequestInitializer() {
    ...
    Credential credential = Auth.getFlow().loadCredential(Auth.DEFAULT_USER);
  ...
  private static void listActivities() throws IOException {
    ...
    Plus.Activities.Search listActivities = plus.activities().search("wolff");
