...
public class ContactPerson extends Thing {
	...
	public static final URI RDFS_CLASS = new URIImpl("http://www.w3.org/2000/10/swap/pim/contact#Person", false);
	 ...
	 */
	protected ContactPerson ( Model model, URI classURI, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public ContactPerson ( Model model, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public ContactPerson ( Model model, String uriString, boolean write) throws ModelRuntimeException {
	 ...
	 */
	public static ContactPerson  getInstance(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getInstance(model, instanceResource, ContactPerson.class);
	}

	/**
	 * Create a new instance of this class in the model. 
	 * That is, create the statement (instanceResource, RDF.type, http://www.w3.org/2000/10/swap/pim/contact#Person).
	 * @param model an RDF2Go model
	 * @param instanceResource an RDF2Go resource
	 *
	 ...
	 */
	public static ReactorResult<? extends ContactPerson> getAllInstances_as(Model model) {
		return Base.getAllInstances_as(model, RDFS_CLASS, ContactPerson.class );
	}

    /**
	 * Remove rdf:type ContactPerson from this instance. Other triples are not affected.
