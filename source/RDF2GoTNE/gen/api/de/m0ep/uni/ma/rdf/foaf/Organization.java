...
public class Organization extends Agent {
	...
	public static final URI RDFS_CLASS = new URIImpl("http://xmlns.com/foaf/0.1/Organization", false);
	 ...
	 */
	protected Organization ( Model model, URI classURI, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public Organization ( Model model, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public Organization ( Model model, String uriString, boolean write) throws ModelRuntimeException {
	 ...
	 */
	public Organization ( Model model, BlankNode bnode, boolean write ) {
	 ...
	 */
	public Organization ( Model model, boolean write ) {
	 ...
	 * @return an instance of Organization  or null if none existst
	 *
	 * [Generated from RDFReactor template rule #class0] 
	 */
	public static Organization  getInstance(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getInstance(model, instanceResource, Organization.class);
	}

	/**
	 * Create a new instance of this class in the model. 
	 * That is, create the statement (instanceResource, RDF.type, http://xmlns.com/foaf/0.1/Organization).
	 * @param model an RDF2Go model
	 * @param instanceResource an RDF2Go resource
	 *
	 ...
	 */
	public static ReactorResult<? extends Organization> getAllInstances_as(Model model) {
		return Base.getAllInstances_as(model, RDFS_CLASS, Organization.class );
	}

    /**
	 * Remove rdf:type Organization from this instance. Other triples are not affected.
