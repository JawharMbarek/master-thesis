...
public class Project extends Thing {
	...
	public static final URI RDFS_CLASS = new URIImpl("http://xmlns.com/foaf/0.1/Project", false);
	 ...
	 */
	protected Project ( Model model, URI classURI, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public Project ( Model model, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public Project ( Model model, String uriString, boolean write) throws ModelRuntimeException {
	 ...
	 */
	public Project ( Model model, BlankNode bnode, boolean write ) {
	 ...
	 */
	public Project ( Model model, boolean write ) {
	 ...
	 * @return an instance of Project  or null if none existst
	 *
	 * [Generated from RDFReactor template rule #class0] 
	 */
	public static Project  getInstance(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getInstance(model, instanceResource, Project.class);
	}

	/**
	 * Create a new instance of this class in the model. 
	 * That is, create the statement (instanceResource, RDF.type, http://xmlns.com/foaf/0.1/Project).
	 * @param model an RDF2Go model
	 * @param instanceResource an RDF2Go resource
	 *
	 ...
	 */
	public static ReactorResult<? extends Project> getAllInstances_as(Model model) {
		return Base.getAllInstances_as(model, RDFS_CLASS, Project.class );
	}

    /**
	 * Remove rdf:type Project from this instance. Other triples are not affected.
