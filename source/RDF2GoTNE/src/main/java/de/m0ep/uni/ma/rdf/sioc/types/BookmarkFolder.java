 ...
 */
public class BookmarkFolder extends Container {

    /**
     * 
     */
    private static final long serialVersionUID = 6201492911754026935L;

    /** http://rdfs.org/sioc/types#BookmarkFolder */
	public static final URI RDFS_CLASS = new URIImpl("http://rdfs.org/sioc/types#BookmarkFolder", false);
	 ...
	 * That is, create the statement (instanceResource, RDF.type, http://rdfs.org/sioc/types#BookmarkFolder).
	 * @param model an RDF2Go model
	 * @param instanceResource an RDF2Go resource
	 *
