...
import de.m0ep.rdf.foaf.OnlineAccount;
...
public interface UserAccount extends SIOCGlobal, OnlineAccount {
    ...
    Set<Image> getSiocAvatar();

    /** An image or depiction used to represent this UserAccount. */
    @subPropertyOf( { "http://xmlns.com/foaf/0.1/depiction" } )
    @Iri( "http://rdfs.org/sioc/ns#avatar" )
    void setSiocAvatar( Set<? extends Image> siocAvatar );
    ...
    Set<Object> getSiocEmail();

    /** An electronic mail address of the UserAccount. */
    @Iri( "http://rdfs.org/sioc/ns#email" )
    void setSiocEmail( Set<?> siocEmail );
    ...
    /**
     * First (real) name of this User. Synonyms include given name or christian
     * name.
     * 
     * @version This property is deprecated. Use foaf:name or foaf:firstName
     *          from the FOAF vocabulary instead.
     */
    @Deprecated
    @Iri( "http://rdfs.org/sioc/ns#first_name" )
    Set<Object> getSiocFirst_name();
    ...
    @Deprecated
    @Iri( "http://rdfs.org/sioc/ns#first_name" )
    void setSiocFirst_name( Set<?> siocFirst_name );
     ...
     * 
     * @version This property is deprecated. Use foaf:name or foaf:surname from
     *          the FOAF vocabulary instead.
     */
    @Deprecated
    @Iri( "http://rdfs.org/sioc/ns#last_name" )
    Set<Object> getSiocLast_name();
    ...
    @Deprecated
    @Iri( "http://rdfs.org/sioc/ns#last_name" )
    void setSiocLast_name( Set<?> siocLast_name );
