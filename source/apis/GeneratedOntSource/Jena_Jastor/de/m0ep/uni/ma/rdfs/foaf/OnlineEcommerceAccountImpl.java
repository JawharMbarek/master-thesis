...
/**
 * Implementation of {@link de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccount}
 ...
 * <br>
 */
public class OnlineEcommerceAccountImpl extends com.ibm.adtech.jastor.ThingImpl implements de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccount {
	...
	OnlineEcommerceAccountImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static OnlineEcommerceAccountImpl getOnlineEcommerceAccount(Resource resource, Model model) throws JastorException {
		return new OnlineEcommerceAccountImpl(resource, model);
	}
	    
	static OnlineEcommerceAccountImpl createOnlineEcommerceAccount(Resource resource, Model model) throws JastorException { 
		OnlineEcommerceAccountImpl impl = new OnlineEcommerceAccountImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, OnlineEcommerceAccount.TYPE)))
			impl._model.add(impl._resource, RDF.type, OnlineEcommerceAccount.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccount.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initFundedBy() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/fundedBy properties in OnlineEcommerceAccount model not a Resource", stmt.getObject());
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/name properties in OnlineEcommerceAccount model not a Literal", stmt.getObject());
	...
	private void initDnaChecksum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/dnaChecksum properties in OnlineEcommerceAccount model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initPhone() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/phone properties in OnlineEcommerceAccount model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPage() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/page properties in OnlineEcommerceAccount model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initNick() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/nick properties in OnlineEcommerceAccount model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			nick.add(literal);
		}
	}
	...
	private void initLogo() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/logo properties in OnlineEcommerceAccount model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initMaker() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/maker properties in OnlineEcommerceAccount model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initGivenname() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/givenname properties in OnlineEcommerceAccount model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initTitle() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/title properties in OnlineEcommerceAccount model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			title.add(literal);
		}
	}
	...
	private void initHomepage() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/homepage properties in OnlineEcommerceAccount model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initAccountServiceHomepage() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/accountServiceHomepage properties in OnlineEcommerceAccount model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initTheme() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/theme properties in OnlineEcommerceAccount model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initAccountName() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/accountName properties in OnlineEcommerceAccount model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof OnlineEcommerceAccountListener))
			throw new IllegalArgumentException("ThingListener must be instance of OnlineEcommerceAccountListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((OnlineEcommerceAccountListener)listener);
		}
	}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFundedBy.iterator();iter.hasNext();){
							OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
							listener.fundedByAdded(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,_fundedBy);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
						listener.nameAdded(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(dnaChecksumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDnaChecksum.iterator();iter.hasNext();){
						OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
						listener.dnaChecksumAdded(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPhone.iterator();iter.hasNext();){
							OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
							listener.phoneAdded(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,_phone);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPage.iterator();iter.hasNext();){
							OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
							listener.pageAdded(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,_page);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nickProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNick.iterator();iter.hasNext();){
						OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
						listener.nickAdded(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLogo.iterator();iter.hasNext();){
							OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
							listener.logoAdded(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,_logo);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMaker.iterator();iter.hasNext();){
							OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
							listener.makerAdded(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,_maker);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(givennameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForGivenname.iterator();iter.hasNext();){
						OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
						listener.givennameAdded(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
						listener.titleAdded(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomepage.iterator();iter.hasNext();){
							OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
							listener.homepageAdded(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,_homepage);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccountServiceHomepage.iterator();iter.hasNext();){
							OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
							listener.accountServiceHomepageAdded(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,_accountServiceHomepage);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTheme.iterator();iter.hasNext();){
							OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
							listener.themeAdded(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,_theme);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(accountNameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAccountName.iterator();iter.hasNext();){
						OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
						listener.accountNameAdded(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,literal);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(fundedByProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFundedBy.iterator();iter.hasNext();){
							OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
							listener.fundedByRemoved(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,_fundedBy);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
						listener.nameRemoved(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(dnaChecksumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDnaChecksum.iterator();iter.hasNext();){
						OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
						listener.dnaChecksumRemoved(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(phoneProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPhone.iterator();iter.hasNext();){
							OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
							listener.phoneRemoved(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,_phone);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(pageProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPage.iterator();iter.hasNext();){
							OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
							listener.pageRemoved(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,_page);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nickProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNick.iterator();iter.hasNext();){
						OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
						listener.nickRemoved(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(logoProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLogo.iterator();iter.hasNext();){
							OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
							listener.logoRemoved(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,_logo);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(makerProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMaker.iterator();iter.hasNext();){
							OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
							listener.makerRemoved(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,_maker);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(givennameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForGivenname.iterator();iter.hasNext();){
						OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
						listener.givennameRemoved(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
						listener.titleRemoved(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,literal);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(homepageProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomepage.iterator();iter.hasNext();){
							OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
							listener.homepageRemoved(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,_homepage);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(accountServiceHomepageProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccountServiceHomepage.iterator();iter.hasNext();){
							OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
							listener.accountServiceHomepageRemoved(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,_accountServiceHomepage);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(themeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTheme.iterator();iter.hasNext();){
							OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
							listener.themeRemoved(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,_theme);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(accountNameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAccountName.iterator();iter.hasNext();){
						OnlineEcommerceAccountListener listener=(OnlineEcommerceAccountListener)iter.next();
						listener.accountNameRemoved(de.m0ep.uni.ma.rdfs.foaf.OnlineEcommerceAccountImpl.this,literal);
					}
				}
				return;
			}
