...
/**
 * Interface for Spatial Thing ontology class<br>
...
public interface SpatialThing extends com.ibm.adtech.jastor.Thing {
	 ...
	 * may be used to remove all such values.
	 * @return		{@link java.util.Iterator} of {@link de.m0ep.uni.ma.rdfs.foaf.SpatialThing}
	 ...
	 * @param		The {@link de.m0ep.uni.ma.rdfs.foaf.SpatialThing} to add
	 * @see			#based__nearProperty
	 */
	public void addBased__near(de.m0ep.uni.ma.rdfs.foaf.SpatialThing based__near) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Adds an anonymous value for the 'based__near' property
	 * @return		The anoymous {@link de.m0ep.uni.ma.rdfs.foaf.SpatialThing} created
	 * @see			#based__nearProperty
	 */
	public de.m0ep.uni.ma.rdfs.foaf.SpatialThing addBased__near() throws com.ibm.adtech.jastor.JastorException;
	 ...
	 * @see			#based__nearProperty
	 */
	public de.m0ep.uni.ma.rdfs.foaf.SpatialThing addBased__near(com.hp.hpl.jena.rdf.model.Resource resource) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Removes a value for the 'based__near' property.  This method should not
	 * be invoked while iterator through values.  In that case, the remove() method of the Iterator
	 * itself should be used.
	 * @param		The {@link de.m0ep.uni.ma.rdfs.foaf.SpatialThing} to remove
	 * @see			#based__nearProperty
	 */
	public void removeBased__near(de.m0ep.uni.ma.rdfs.foaf.SpatialThing based__near) throws com.ibm.adtech.jastor.JastorException;
