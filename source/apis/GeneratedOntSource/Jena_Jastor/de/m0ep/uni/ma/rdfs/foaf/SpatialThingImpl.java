...
/**
 * Implementation of {@link de.m0ep.uni.ma.rdfs.foaf.SpatialThing}
 ...
 * <br>
 */
public class SpatialThingImpl extends com.ibm.adtech.jastor.ThingImpl implements de.m0ep.uni.ma.rdfs.foaf.SpatialThing {
	...
	SpatialThingImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static SpatialThingImpl getSpatialThing(Resource resource, Model model) throws JastorException {
		return new SpatialThingImpl(resource, model);
	}
	    
	static SpatialThingImpl createSpatialThing(Resource resource, Model model) throws JastorException { 
		SpatialThingImpl impl = new SpatialThingImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, SpatialThing.TYPE)))
			impl._model.add(impl._resource, RDF.type, SpatialThing.TYPE);
		impl.addSuperTypes();
	...
	private void initFundedBy() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/fundedBy properties in SpatialThing model not a Resource", stmt.getObject());
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/name properties in SpatialThing model not a Literal", stmt.getObject());
	...
	private void initDnaChecksum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/dnaChecksum properties in SpatialThing model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initPhone() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/phone properties in SpatialThing model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPage() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/page properties in SpatialThing model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initNick() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/nick properties in SpatialThing model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			nick.add(literal);
		}
	}
	...
	private void initLogo() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/logo properties in SpatialThing model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initMaker() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/maker properties in SpatialThing model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initGivenname() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/givenname properties in SpatialThing model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initTitle() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/title properties in SpatialThing model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			title.add(literal);
		}
	}
	...
	private void initHomepage() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/homepage properties in SpatialThing model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initTheme() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/theme properties in SpatialThing model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof SpatialThingListener))
			throw new IllegalArgumentException("ThingListener must be instance of SpatialThingListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((SpatialThingListener)listener);
		}
	}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFundedBy.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.fundedByAdded(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,_fundedBy);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.nameAdded(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(dnaChecksumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDnaChecksum.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.dnaChecksumAdded(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPhone.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.phoneAdded(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,_phone);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPage.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.pageAdded(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,_page);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nickProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNick.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.nickAdded(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBased__near.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.based__nearAdded(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,_based__near);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLogo.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.logoAdded(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,_logo);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMaker.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.makerAdded(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,_maker);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(givennameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForGivenname.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.givennameAdded(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.titleAdded(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomepage.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.homepageAdded(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,_homepage);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTheme.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.themeAdded(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,_theme);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(fundedByProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFundedBy.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.fundedByRemoved(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,_fundedBy);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.nameRemoved(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(dnaChecksumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDnaChecksum.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.dnaChecksumRemoved(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(phoneProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPhone.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.phoneRemoved(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,_phone);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(pageProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPage.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.pageRemoved(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,_page);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nickProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNick.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.nickRemoved(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(based__nearProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBased__near.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.based__nearRemoved(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,_based__near);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(logoProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLogo.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.logoRemoved(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,_logo);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(makerProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMaker.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.makerRemoved(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,_maker);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(givennameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForGivenname.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.givennameRemoved(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.titleRemoved(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(homepageProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomepage.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.homepageRemoved(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,_homepage);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(themeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTheme.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.themeRemoved(de.m0ep.uni.ma.rdfs.foaf.SpatialThingImpl.this,_theme);
						}
					}
				}
				return;
