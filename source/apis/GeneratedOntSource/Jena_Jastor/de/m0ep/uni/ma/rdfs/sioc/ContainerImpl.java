...
/**
 * Implementation of {@link de.m0ep.uni.ma.rdfs.sioc.Container}
 * Use the de.m0ep.uni.ma.rdfs.sioc.Factory to create instances of this class.
 * <p>(URI: http://rdfs.org/sioc/ns#Container)</p>
 * <br>
 */
public class ContainerImpl extends com.ibm.adtech.jastor.ThingImpl implements de.m0ep.uni.ma.rdfs.sioc.Container {
	...
	ContainerImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static ContainerImpl getContainer(Resource resource, Model model) throws JastorException {
		return new ContainerImpl(resource, model);
	}
	    
	static ContainerImpl createContainer(Resource resource, Model model) throws JastorException { 
		ContainerImpl impl = new ContainerImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, Container.TYPE)))
			impl._model.add(impl._resource, RDF.type, Container.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, de.m0ep.uni.ma.rdfs.sioc.Container.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	private void initLink() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#link properties in Container model not a Resource", stmt.getObject());
	...
	private void initNote() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#note properties in Container model not a Literal", stmt.getObject());
	...
	private void initNum__items() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#num_items properties in Container model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__creator() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_creator properties in Container model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__owner() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_owner properties in Container model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initDescription() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/description properties in Container model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__parent() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_parent properties in Container model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				de.m0ep.uni.ma.rdfs.sioc.Container has__parent = de.m0ep.uni.ma.rdfs.sioc.Factory.getContainer(resource,_model);
	...
	public void addHas__parent(de.m0ep.uni.ma.rdfs.sioc.Container has__parent) throws JastorException {
	...
	public de.m0ep.uni.ma.rdfs.sioc.Container addHas__parent() throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.Container has__parent = de.m0ep.uni.ma.rdfs.sioc.Factory.createContainer(_model.createResource(),_model);
		if (this.has__parent == null)
			initHas__parent();
		this.has__parent.add(has__parent);
		_model.add(_model.createStatement(_resource,has__parentProperty,has__parent.resource()));
	...
	public de.m0ep.uni.ma.rdfs.sioc.Container addHas__parent(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.Container has__parent = de.m0ep.uni.ma.rdfs.sioc.Factory.getContainer(resource,_model);
		if (this.has__parent == null)
			initHas__parent();
		if (this.has__parent.contains(has__parent))
	...
	public void removeHas__parent(de.m0ep.uni.ma.rdfs.sioc.Container has__parent) throws JastorException {
		if (this.has__parent == null)
			initHas__parent();
		if (!this.has__parent.contains(has__parent))
			return;
	...
	private void initContainer__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#container_of properties in Container model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				de.m0ep.uni.ma.rdfs.sioc.Item container__of = de.m0ep.uni.ma.rdfs.sioc.Factory.getItem(resource,_model);
	...
	public void addContainer__of(de.m0ep.uni.ma.rdfs.sioc.Item container__of) throws JastorException {
	...
	public de.m0ep.uni.ma.rdfs.sioc.Item addContainer__of() throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.Item container__of = de.m0ep.uni.ma.rdfs.sioc.Factory.createItem(_model.createResource(),_model);
		if (this.container__of == null)
			initContainer__of();
		this.container__of.add(container__of);
		_model.add(_model.createStatement(_resource,container__ofProperty,container__of.resource()));
	...
	public de.m0ep.uni.ma.rdfs.sioc.Item addContainer__of(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.Item container__of = de.m0ep.uni.ma.rdfs.sioc.Factory.getItem(resource,_model);
		if (this.container__of == null)
			initContainer__of();
		if (this.container__of.contains(container__of))
	...
	public void removeContainer__of(de.m0ep.uni.ma.rdfs.sioc.Item container__of) throws JastorException {
		if (this.container__of == null)
			initContainer__of();
		if (!this.container__of.contains(container__of))
			return;
	...
	private void initSubject() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/subject properties in Container model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initNum__authors() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#num_authors properties in Container model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.String","http://www.w3.org/2001/XMLSchema#nonNegativeInteger");
			if (obj != null)
	...
	private void initNum__views() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#num_views properties in Container model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.String","http://www.w3.org/2001/XMLSchema#nonNegativeInteger");
			if (obj != null)
				num__views.add(obj);
	...
	private void initReferences() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/references properties in Container model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initTopic() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#topic properties in Container model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initLast__activity__date() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#last_activity_date properties in Container model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHas__subscriber() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_subscriber properties in Container model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				de.m0ep.uni.ma.rdfs.sioc.UserAccount has__subscriber = de.m0ep.uni.ma.rdfs.sioc.Factory.getUserAccount(resource,_model);
	...
	public void addHas__subscriber(de.m0ep.uni.ma.rdfs.sioc.UserAccount has__subscriber) throws JastorException {
	...
	public de.m0ep.uni.ma.rdfs.sioc.UserAccount addHas__subscriber() throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.UserAccount has__subscriber = de.m0ep.uni.ma.rdfs.sioc.Factory.createUserAccount(_model.createResource(),_model);
		if (this.has__subscriber == null)
			initHas__subscriber();
		this.has__subscriber.add(has__subscriber);
		_model.add(_model.createStatement(_resource,has__subscriberProperty,has__subscriber.resource()));
	...
	public de.m0ep.uni.ma.rdfs.sioc.UserAccount addHas__subscriber(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.UserAccount has__subscriber = de.m0ep.uni.ma.rdfs.sioc.Factory.getUserAccount(resource,_model);
		if (this.has__subscriber == null)
			initHas__subscriber();
		if (this.has__subscriber.contains(has__subscriber))
	...
	public void removeHas__subscriber(de.m0ep.uni.ma.rdfs.sioc.UserAccount has__subscriber) throws JastorException {
		if (this.has__subscriber == null)
			initHas__subscriber();
		if (!this.has__subscriber.contains(has__subscriber))
			return;
	...
	private void initId() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#id properties in Container model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			id.add(literal);
		}
	}
	...
	private void initLast__item__date() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#last_item_date properties in Container model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initLinks__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#links_to properties in Container model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initLast__reply__date() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#last_reply_date properties in Container model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initNum__replies() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#num_replies properties in Container model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.String","http://www.w3.org/2001/XMLSchema#nonNegativeInteger");
			if (obj != null)
	...
	private void initHas__function() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_function properties in Container model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initParent__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#parent_of properties in Container model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				de.m0ep.uni.ma.rdfs.sioc.Container parent__of = de.m0ep.uni.ma.rdfs.sioc.Factory.getContainer(resource,_model);
	...
	public void addParent__of(de.m0ep.uni.ma.rdfs.sioc.Container parent__of) throws JastorException {
	...
	public de.m0ep.uni.ma.rdfs.sioc.Container addParent__of() throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.Container parent__of = de.m0ep.uni.ma.rdfs.sioc.Factory.createContainer(_model.createResource(),_model);
		if (this.parent__of == null)
			initParent__of();
		this.parent__of.add(parent__of);
		_model.add(_model.createStatement(_resource,parent__ofProperty,parent__of.resource()));
	...
	public de.m0ep.uni.ma.rdfs.sioc.Container addParent__of(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.Container parent__of = de.m0ep.uni.ma.rdfs.sioc.Factory.getContainer(resource,_model);
		if (this.parent__of == null)
			initParent__of();
		if (this.parent__of.contains(parent__of))
	...
	public void removeParent__of(de.m0ep.uni.ma.rdfs.sioc.Container parent__of) throws JastorException {
		if (this.parent__of == null)
			initParent__of();
		if (!this.parent__of.contains(parent__of))
			return;
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#name properties in Container model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			name.add(literal);
		}
	}
	...
	private void initHas__space() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_space properties in Container model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initRelated__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#related_to properties in Container model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initDate() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/date properties in Container model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			date.add(literal);
		}
	}
	...
	private void initTitle() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/title properties in Container model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			title.add(literal);
		}
	}
	...
	private void initScope__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#scope_of properties in Container model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initFeed() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#feed properties in Container model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initDepiction() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/depiction properties in Container model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof ContainerListener))
			throw new IllegalArgumentException("ThingListener must be instance of ContainerListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((ContainerListener)listener);
		}
	}
	...
	public void unregisterListener(ThingListener listener) {
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLink.iterator();iter.hasNext();){
							...
							listener.linkAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_link);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(noteProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNote.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.noteAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__itemsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__items.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.num__itemsAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__creator.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.has__creatorAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_has__creator);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__owner.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.has__ownerAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_has__owner);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDescription.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.descriptionAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__parentProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					de.m0ep.uni.ma.rdfs.sioc.Container _has__parent = null;
					try {
						_has__parent = de.m0ep.uni.ma.rdfs.sioc.Factory.getContainer(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__parent == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__parent.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.has__parentAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_has__parent);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(container__ofProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					de.m0ep.uni.ma.rdfs.sioc.Item _container__of = null;
					try {
						_container__of = de.m0ep.uni.ma.rdfs.sioc.Factory.getItem(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (container__of == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForContainer__of.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.container__ofAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_container__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubject.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.subjectAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_subject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__authorsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__authors.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.num__authorsAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__viewsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__views.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.num__viewsAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReferences.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.referencesAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_references);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.topicAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_topic);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__activity__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__activity__date.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.last__activity__dateAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__subscriberProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					de.m0ep.uni.ma.rdfs.sioc.UserAccount _has__subscriber = null;
					try {
						_has__subscriber = de.m0ep.uni.ma.rdfs.sioc.Factory.getUserAccount(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__subscriber == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__subscriber.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.has__subscriberAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_has__subscriber);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(idProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForId.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.idAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(last__item__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__item__date.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.last__item__dateAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLinks__to.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.links__toAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_links__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__reply__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__reply__date.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.last__reply__dateAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__repliesProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__replies.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.num__repliesAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__function.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.has__functionAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_has__function);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(parent__ofProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					de.m0ep.uni.ma.rdfs.sioc.Container _parent__of = null;
					try {
						_parent__of = de.m0ep.uni.ma.rdfs.sioc.Factory.getContainer(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (parent__of == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParent__of.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.parent__ofAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_parent__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.nameAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__space.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.has__spaceAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_has__space);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRelated__to.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.related__toAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_related__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDate.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.dateAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.titleAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForScope__of.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.scope__ofAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_scope__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeed.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.feedAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_feed);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.depictionAdded(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_depiction);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(linkProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLink.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.linkRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_link);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(noteProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNote.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.noteRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__itemsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.num__itemsRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__creatorProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__creator.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.has__creatorRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_has__creator);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ownerProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__owner.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.has__ownerRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_has__owner);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDescription.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.descriptionRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__parent != null) {
						...
						for (int i=0;i<has__parent.size();i++) {
							de.m0ep.uni.ma.rdfs.sioc.Container __item = (de.m0ep.uni.ma.rdfs.sioc.Container) has__parent.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__parent = __item;
								break;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__parent.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.has__parentRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_has__parent);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (container__of != null) {
						...
						for (int i=0;i<container__of.size();i++) {
							de.m0ep.uni.ma.rdfs.sioc.Item __item = (de.m0ep.uni.ma.rdfs.sioc.Item) container__of.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForContainer__of.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.container__ofRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_container__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(subjectProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubject.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.subjectRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_subject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__authorsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.num__authorsRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__viewsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.num__viewsRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(referencesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReferences.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.referencesRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_references);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(topicProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.topicRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_topic);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__activity__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__activity__date.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.last__activity__dateRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__subscriber != null) {
						...
						for (int i=0;i<has__subscriber.size();i++) {
							de.m0ep.uni.ma.rdfs.sioc.UserAccount __item = (de.m0ep.uni.ma.rdfs.sioc.UserAccount) has__subscriber.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__subscriber.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.has__subscriberRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_has__subscriber);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(idProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForId.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.idRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(last__item__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__item__date.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.last__item__dateRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(links__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLinks__to.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.links__toRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_links__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__reply__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__reply__date.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.last__reply__dateRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__repliesProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.num__repliesRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__functionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__function.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.has__functionRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_has__function);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (parent__of != null) {
						...
						for (int i=0;i<parent__of.size();i++) {
							de.m0ep.uni.ma.rdfs.sioc.Container __item = (de.m0ep.uni.ma.rdfs.sioc.Container) parent__of.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_parent__of = __item;
								break;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParent__of.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.parent__ofRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_parent__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.nameRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__spaceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__space.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.has__spaceRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_has__space);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(related__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRelated__to.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.related__toRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_related__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDate.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.dateRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						ContainerListener listener=(ContainerListener)iter.next();
						listener.titleRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(scope__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForScope__of.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.scope__ofRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_scope__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(feedProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeed.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.feedRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_feed);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(depictionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							ContainerListener listener=(ContainerListener)iter.next();
							listener.depictionRemoved(de.m0ep.uni.ma.rdfs.sioc.ContainerImpl.this,_depiction);
						}
					}
				}
				return;
