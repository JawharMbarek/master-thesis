...
public class CanvasTest {
	public static void main( String[] args ) {
		...
		/*
		System.out.println();
		System.out.println( "Create entry in topic course=798152, id=1424406" );
		System.out.println( "-----------------" );
		...
		System.out.println();
		System.out.println( "Create reply to entry course=798152, topic=1424406, id=3084155" );
		System.out.println( "-----------------" );
		...
		*/
		...
		System.out.println();
		System.out.println( "List Groups of Course id=798152" );
		System.out.println( "-----------------" );

		Pagination<Group> groupPages;
		try {
			groupPages = client.groups()
			        .listFromCourse( 798152 )
			        .executePagination();
		} catch ( CanvasLmsException e ) {
			e.printStackTrace();
			return;
		...
		if ( null != groupPages ) {
			for ( List<Group> page : groupPages ) {
