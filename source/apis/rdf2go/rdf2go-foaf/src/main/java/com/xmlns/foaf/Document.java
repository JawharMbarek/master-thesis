...
public class Document extends Thing {
	...
	return Base.getAll_Inverse(this.model, Thing.HOMEPAGE,
		this.getResource());
    }
	...
	return Base.getAll_Inverse(this.model, Thing.PAGE,
		this.getResource());
    }
    ...
    public static ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllPrimaryTopicOf_Inverse(
	    Model model, Object objectValue) {
	return Base
		.getAll_Inverse(model, Thing.PRIMARYTOPICOF, objectValue);
    }
	...
	return Base.getAll_Inverse(this.model, Thing.PRIMARYTOPICOF,
		this.getResource());
    }
     ...
     *         [Generated from RDFReactor template rule #get11static]
     */
    public static ClosableIterator<Thing> getAllSha1Sums(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	return Base.getAll(model, instanceResource, SHA1SUM, Thing.class);
    }
     ...
     * [Generated from RDFReactor template rule #get12dynamic]
     */
    public ClosableIterator<Thing> getAllSha1Sums() {
     ...
     * [Generated from RDFReactor template rule #add4dynamic]
     */
    public void addSha1Sum(Thing value) {
	Base.add(this.model, this.getResource(), SHA1SUM, value);
    }
     ...
     *            [Generated from RDFReactor template rule #set4dynamic]
     */
    public void setSha1Sum(Thing value) {
	Base.set(this.model, this.getResource(), SHA1SUM, value);
    }
     ...
     *            [Generated from RDFReactor template rule #remove4dynamic]
     */
    public void removeSha1Sum(Thing value) {
	Base.remove(this.model, this.getResource(), SHA1SUM, value);
    }
     ...
     *         [Generated from RDFReactor template rule #get11static]
     */
    public static ClosableIterator<Thing> getAllTopics(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
     ...
     * [Generated from RDFReactor template rule #get12dynamic]
     */
    public ClosableIterator<Thing> getAllTopics() {
