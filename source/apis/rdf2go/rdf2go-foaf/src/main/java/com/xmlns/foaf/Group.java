...
public class Group extends Agent {
    ...
    public static final URI RDFS_CLASS = new URIImpl(
	    "http://xmlns.com/foaf/0.1/Group", false);

    /** http://xmlns.com/foaf/0.1/member */
    public static final URI MEMBER = new URIImpl(
	    "http://xmlns.com/foaf/0.1/member", false);
     ...
     */
    protected Group(Model model, URI classURI,
     ...
     */
    public Group(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static Group getInstance(Model model,
     ...
     * statement (instanceResource, RDF.type, http://xmlns.com/foaf/0.1/Group).
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@53c2ff4e has at
     * least one value set
     * 
     * @param model
     *            an RDF2Go model
     ...
     */
    public static boolean hasGroupMembers(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@53c2ff4e has
     ...
     */
    public static ClosableIterator<org.ontoware.rdf2go.model.node.Node> getAllGroupMembers_asNode(
	    Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
     ...
     */
    public ClosableIterator<org.ontoware.rdf2go.model.node.Node> getAllGroupMembers_asNode() {
     ...
     */
    public static ClosableIterator<Agent> getAllGroupMembers(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
     ...
     */
    public ClosableIterator<Agent> getAllGroupMembers() {
    ...
    /**
     * Sets a value of property Member from an instance of Agent First, all
     ...
     */
    public static void removeAllGroupMembers(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
