...
public class OnlineEcommerceAccount extends OnlineAccount {
    ...
    public static final URI RDFS_CLASS = new URIImpl(
	    "http://xmlns.com/foaf/0.1/OnlineEcommerceAccount", false);
     ...
     */
    protected OnlineEcommerceAccount(Model model, URI classURI,
     ...
     */
    public OnlineEcommerceAccount(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceIdentifier,
	    boolean write) {
     ...
     */
    public OnlineEcommerceAccount(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static OnlineEcommerceAccount getInstance(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	return Base.getInstance(model, instanceResource,
		OnlineEcommerceAccount.class);
    }
    ...
    /**
     * Remove rdf:type OnlineE_commerceAccount from this instance. Other triples
