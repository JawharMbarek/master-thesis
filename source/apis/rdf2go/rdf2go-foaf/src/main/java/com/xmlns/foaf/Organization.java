...
public class Organization extends Agent {
    ...
    public static final URI RDFS_CLASS = new URIImpl(
	    "http://xmlns.com/foaf/0.1/Organization", false);
     ...
     */
    protected Organization(Model model, URI classURI,
     ...
     */
    public Organization(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceIdentifier,
	    boolean write) {
     ...
     */
    public Organization(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static Organization getInstance(Model model,
    ...
    /**
     * Remove rdf:type Organization from this instance. Other triples are not
