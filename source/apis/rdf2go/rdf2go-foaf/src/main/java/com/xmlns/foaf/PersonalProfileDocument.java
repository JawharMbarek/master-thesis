...
public class PersonalProfileDocument extends Document {
    ...
    public static final URI RDFS_CLASS = new URIImpl(
	    "http://xmlns.com/foaf/0.1/PersonalProfileDocument", false);
     ...
     */
    protected PersonalProfileDocument(Model model, URI classURI,
     ...
     */
    public PersonalProfileDocument(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceIdentifier,
	    boolean write) {
     ...
     */
    public PersonalProfileDocument(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static PersonalProfileDocument getInstance(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	return Base.getInstance(model, instanceResource,
		PersonalProfileDocument.class);
    }
    ...
    /**
     * Remove rdf:type PersonalProfileDocument from this instance. Other triples
     * are not affected. To delete more, use deleteAllProperties
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
