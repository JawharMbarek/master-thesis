...
public class SpatialThing extends Thing {
    ...
    public static final URI RDFS_CLASS = new URIImpl(
	    "http://www.w3.org/2003/01/geo/wgs84_pos#SpatialThing", false);
     ...
     */
    protected SpatialThing(Model model, URI classURI,
     ...
     */
    public SpatialThing(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceIdentifier,
	    boolean write) {
     ...
     */
    public SpatialThing(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static SpatialThing getInstance(Model model,
    ...
    /**
     * Remove rdf:type SpatialThing from this instance. Other triples are not
     ...
     *            an RDF2Go model
     * @param objectValue
     * @return all A's as RDF resources, that have a relation 'BasedNear' to
     *         this SpatialThing instance
     * 
     *         [Generated from RDFReactor template rule #getallinverse1static]
     */
    public static ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllBasedNear_Inverse(
     ...
     */
    public ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllBasedNear_Inverse() {
	return Base.getAll_Inverse(this.model, SpatialThing.BASEDNEAR,
		this.getResource());
    }
