 ...
 * 12:01 PM
 */
public class ClientSecret extends Credentials {

    private static final long serialVersionUID = -7939972894981146807L;

    /** http://www.m0ep.de/sioc/services/auth#ClientSecret */
    public static final URI RDFS_CLASS = new URIImpl(
            "http://www.m0ep.de/sioc/services/auth#ClientSecret", false );
     ...
     */
    protected ClientSecret( Model model, URI classURI, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public ClientSecret( Model model, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public ClientSecret( Model model, String uriString, boolean write )
            throws ModelRuntimeException {
     ...
     */
    public ClientSecret( Model model, BlankNode bnode, boolean write ) {
     ...
     */
    public ClientSecret( Model model, boolean write ) {
     ...
     *            an RDF2Go resource
     * @return an instance of ClientSecret or null if none existst
     * 
     *         [Generated from RDFReactor template rule #class0]
     */
    public static ClientSecret getInstance( Model model, Resource instanceResource ) {
        return Base.getInstance( model, instanceResource, ClientSecret.class );
    }

    /**
     * Create a new instance of this class in the model. That is, create the statement
     * (instanceResource, RDF.type, http://www.m0ep.de/sioc/services/auth#ClientSecret).
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
    ...
    /**
     * Remove triple {@code (this, rdf:type, ClientSecret)} from this instance. Other triples are
