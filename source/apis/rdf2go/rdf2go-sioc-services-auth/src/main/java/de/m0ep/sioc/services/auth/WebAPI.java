 ...
 * 12:01 PM
 */
public class WebAPI extends AuthenticationMechanism {

    private static final long serialVersionUID = -750657929503851347L;

    /** http://www.m0ep.de/sioc/services/auth#WebAPI */
    public static final URI RDFS_CLASS = new URIImpl(
            "http://www.m0ep.de/sioc/services/auth#WebAPI", false );
     ...
     */
    protected WebAPI( Model model, URI classURI, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public WebAPI( Model model, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public WebAPI( Model model, String uriString, boolean write ) throws ModelRuntimeException {
     ...
     */
    public WebAPI( Model model, BlankNode bnode, boolean write ) {
     ...
     */
    public WebAPI( Model model, boolean write ) {
     ...
     *            an RDF2Go resource
     * @return an instance of WebAPI or null if none existst
     * 
     *         [Generated from RDFReactor template rule #class0]
     */
    public static WebAPI getInstance( Model model, Resource instanceResource ) {
        return Base.getInstance( model, instanceResource, WebAPI.class );
    }

    /**
     * Create a new instance of this class in the model. That is, create the statement
     * (instanceResource, RDF.type, http://www.m0ep.de/sioc/services/auth#WebAPI).
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
    ...
    /**
     * Remove triple {@code (this, rdf:type, WebAPI)} from this instance. Other triples are not
