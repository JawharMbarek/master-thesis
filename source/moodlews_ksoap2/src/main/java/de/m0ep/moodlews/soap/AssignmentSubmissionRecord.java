...
public class AssignmentSubmissionRecord  extends SoapObject  implements Soapeabilisable{
    ...
    private de.m0ep.moodlews.soap.FileRecord[] files;
	...
	List<Soapeabilisable> _files = KSoap2Utils.getList(
		(SoapObject) response.getProperty("files"), new FileRecord(
			this.namespace));
     ...
     * @return files
     */
    public de.m0ep.moodlews.soap.FileRecord[] getFiles() {
        return files;
    }
     ...
     * @param files
     */
    public void setFiles(de.m0ep.moodlews.soap.FileRecord[] files) {
        this.files = files;
