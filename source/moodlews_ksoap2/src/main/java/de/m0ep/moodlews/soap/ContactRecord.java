...
public class ContactRecord  extends SoapObject  implements Soapeabilisable{
    ...
    private de.m0ep.moodlews.soap.ProfileitemRecord[] profile;
	...
	List<Soapeabilisable> _profile = KSoap2Utils.getList(
		(SoapObject) response.getProperty("profile"),
     ...
     * @return profile
     */
    public de.m0ep.moodlews.soap.ProfileitemRecord[] getProfile() {
        return profile;
    }
     ...
     * @param profile
     */
    public void setProfile(de.m0ep.moodlews.soap.ProfileitemRecord[] profile) {
