 ...
 */
public class Concept extends FOAFThing {
    ...
    public static final URI RDFS_CLASS = new URIImpl(
	    "http://www.w3.org/2004/02/skos/core#Concept", false);

    /** http://xmlns.com/foaf/0.1/focus */
    public static final URI FOCUS = new URIImpl(
	    "http://xmlns.com/foaf/0.1/focus", false);
     ...
     */
    protected Concept(Model model, URI classURI,
     ...
     */
    public Concept(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static Concept getInstance(Model model,
    ...
    /**
     * Remove rdf:type Concept from this instance. Other triples are not
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@252bb82b has at
     * least one value set
     * 
     * @param model
     *            an RDF2Go model
     ...
     */
    public static boolean hasFocus(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@252bb82b has
     ...
     */
    public boolean hasFocus(org.ontoware.rdf2go.model.node.Node value) {
     ...
     */
    public static ClosableIterator<org.ontoware.rdf2go.model.node.Node> getAllFocus_asNode(
	    Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
     ...
     */
    public ClosableIterator<org.ontoware.rdf2go.model.node.Node> getAllFocus_asNode() {
     ...
     */
    public static ClosableIterator<org.ontoware.rdfreactor.schema.owl.OwlThing> getAllFocus(
	    Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
     ...
     */
    public ClosableIterator<org.ontoware.rdfreactor.schema.owl.OwlThing> getAllFocus() {
     ...
     */
    public static void addFocus(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource,
	    org.ontoware.rdf2go.model.node.Node value) {
     ...
     */
    public void addFocus(org.ontoware.rdf2go.model.node.Node value) {
     ...
     */
    public void addFocus(org.ontoware.rdfreactor.schema.owl.OwlThing value) {
	Base.add(this.model, this.getResource(), FOCUS, value);
    }

    /**
     * Sets a value of property Focus from an RDF2Go node. First, all existing
     ...
     */
    public static void setFocus(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource,
	    org.ontoware.rdf2go.model.node.Node value) {
     ...
     */
    public void setFocus(org.ontoware.rdf2go.model.node.Node value) {
     ...
     */
    public void setFocus(org.ontoware.rdfreactor.schema.owl.OwlThing value) {
	Base.set(this.model, this.getResource(), FOCUS, value);
    }
     ...
     */
    public static void removeFocus(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource,
	    org.ontoware.rdf2go.model.node.Node value) {
     ...
     */
    public void removeFocus(org.ontoware.rdf2go.model.node.Node value) {
     ...
     */
    public void removeFocus(org.ontoware.rdfreactor.schema.owl.OwlThing value) {
	Base.remove(this.model, this.getResource(), FOCUS, value);
    }
     ...
     */
    public static void removeAllFocus(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	Base.removeAll(model, instanceResource, FOCUS);
    }

    /**
     * Removes all values of property Focus * [Generated from RDFReactor
