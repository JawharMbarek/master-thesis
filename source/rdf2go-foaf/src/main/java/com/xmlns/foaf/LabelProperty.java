...
public class LabelProperty extends FOAFThing {
    ...
    public static final URI RDFS_CLASS = new URIImpl(
	    "http://xmlns.com/foaf/0.1/LabelProperty", false);
     ...
     */
    protected LabelProperty(Model model, URI classURI,
     ...
     */
    public LabelProperty(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceIdentifier,
	    boolean write) {
     ...
     */
    public LabelProperty(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static LabelProperty getInstance(Model model,
    ...
    /**
     * Remove rdf:type LabelProperty from this instance. Other triples are not
