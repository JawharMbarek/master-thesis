...
public class OnlineGamingAccount extends OnlineAccount {
    ...
    public static final URI RDFS_CLASS = new URIImpl(
	    "http://xmlns.com/foaf/0.1/OnlineGamingAccount", false);
     ...
     */
    protected OnlineGamingAccount(Model model, URI classURI,
     ...
     */
    public OnlineGamingAccount(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceIdentifier,
	    boolean write) {
     ...
     */
    public OnlineGamingAccount(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static OnlineGamingAccount getInstance(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	return Base.getInstance(model, instanceResource,
		OnlineGamingAccount.class);
    }
    ...
    /**
     * Remove rdf:type OnlineGamingAccount from this instance. Other triples are
