...
public class Project extends FOAFThing {
    ...
    public static final URI RDFS_CLASS = new URIImpl(
	    "http://xmlns.com/foaf/0.1/Project", false);
     ...
     */
    protected Project(Model model, URI classURI,
     ...
     */
    public Project(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static Project getInstance(Model model,
    ...
    /**
     * Remove rdf:type Project from this instance. Other triples are not
