 ...
 */
public class APIKey extends Credential {
    private static final long serialVersionUID = 3522398175758737910L;

    /** http://www.m0ep.de/sioc-service-auth#APIKey */
     ...
     */
    protected APIKey(Model model, URI classURI,
     ...
     */
    public APIKey(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static APIKey getInstance(Model model,
     ...
     */
    public static ReactorResult<? extends APIKey> getAllInstances_as(Model model) {
	return Base.getAllInstances_as(model, RDFS_CLASS, APIKey.class);
    }

    /**
     * Remove rdf:type APIKey from this instance. Other triples are not
