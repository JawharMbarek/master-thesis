...
public class AccessToken extends Credential {
    private static final long serialVersionUID = -8499344086130177141L;

    /** http://www.m0ep.de/sioc-service-auth#AccessToken */
     ...
     */
    protected AccessToken(Model model, URI classURI,
     ...
     */
    public AccessToken(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceIdentifier,
	    boolean write) {
     ...
     */
    public AccessToken(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static AccessToken getInstance(Model model,
     ...
     */
    public static ReactorResult<? extends AccessToken> getAllInstances_as(
	    Model model) {
	return Base.getAllInstances_as(model, RDFS_CLASS, AccessToken.class);
    }

    /**
     * Remove rdf:type AccessToken from this instance. Other triples are not
