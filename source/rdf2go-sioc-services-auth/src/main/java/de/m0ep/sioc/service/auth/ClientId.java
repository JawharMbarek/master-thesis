 ...
 */
public class ClientId extends Credential {
    private static final long serialVersionUID = -5174796252288533243L;

    /** http://www.m0ep.de/sioc-service-auth#ClientId */
     ...
     */
    protected ClientId(Model model, URI classURI,
     ...
     */
    public ClientId(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static ClientId getInstance(Model model,
     ...
     */
    public static ReactorResult<? extends ClientId> getAllInstances_as(
	    Model model) {
	return Base.getAllInstances_as(model, RDFS_CLASS, ClientId.class);
    }

    /**
     * Remove rdf:type ClientId from this instance. Other triples are not
