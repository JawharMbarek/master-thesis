 ...
 */
public class ClientSecret extends Credential {
    private static final long serialVersionUID = -1696246481546783949L;

    /** http://www.m0ep.de/sioc-service-auth#ClientSecret */
     ...
     */
    protected ClientSecret(Model model, URI classURI,
     ...
     */
    public ClientSecret(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceIdentifier,
	    boolean write) {
     ...
     */
    public static ClientSecret getInstance(Model model,
     ...
     */
    public static ReactorResult<? extends ClientSecret> getAllInstances_as(
	    Model model) {
	return Base.getAllInstances_as(model, RDFS_CLASS, ClientSecret.class);
    }

    /**
     * Remove rdf:type ClientSecret from this instance. Other triples are not
