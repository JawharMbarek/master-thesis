 ...
 */
public class Credential extends Thing {
    private static final long serialVersionUID = -1942620306833594787L;
     ...
     */
    protected Credential(Model model, URI classURI,
     ...
     */
    public Credential(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public Credential(Model model, BlankNode bnode, boolean write) {
     ...
     */
    public Credential(Model model, boolean write) {
     ...
     *            an RDF2Go resource
     * @return an instance of Credential or null if none existst
     * 
     *         [Generated from RDFReactor template rule #class0]
     */
    public static Credential getInstance(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	return Base.getInstance(model, instanceResource, Credential.class);
    }
