 ...
 */
public class Direct extends Authentication {
    private static final long serialVersionUID = -8029411859493176410L;

    /** http://www.m0ep.de/sioc-service-auth#Direct */
     ...
     */
    protected Direct(Model model, URI classURI,
     ...
     */
    public Direct(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static Direct getInstance(Model model,
     ...
     */
    public static ReactorResult<? extends Direct> getAllInstances_as(Model model) {
	return Base.getAllInstances_as(model, RDFS_CLASS, Direct.class);
    }

    /**
     * Remove rdf:type Direct from this instance. Other triples are not
