...
public class Password extends Credential {
    private static final long serialVersionUID = 2783566397336029501L;

    /** http://www.m0ep.de/sioc-service-auth#Password */
     ...
     */
    protected Password(Model model, URI classURI,
     ...
     */
    public Password(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static Password getInstance(Model model,
     ...
     */
    public static ReactorResult<? extends Password> getAllInstances_as(
	    Model model) {
	return Base.getAllInstances_as(model, RDFS_CLASS, Password.class);
    }

    /**
     * Remove rdf:type Password from this instance. Other triples are not
