...
public class RefreshToken extends Credential {
    private static final long serialVersionUID = 3985631240138769322L;

    /** http://www.m0ep.de/sioc-service-auth#RefreshToken */
     ...
     */
    protected RefreshToken(Model model, URI classURI,
     ...
     */
    public RefreshToken(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceIdentifier,
	    boolean write) {
     ...
     */
    public static RefreshToken getInstance(Model model,
     ...
     */
    public static ReactorResult<? extends RefreshToken> getAllInstances_as(
	    Model model) {
	return Base.getAllInstances_as(model, RDFS_CLASS, RefreshToken.class);
    }

    /**
     * Remove rdf:type RefreshToken from this instance. Other triples are not
