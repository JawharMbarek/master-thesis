...
public class Service extends org.rdfs.sioc.services.Service {
    private static final long serialVersionUID = -205735107273415456L;
    ...
    public static final URI REQUIREAUTHENTICATION = new URIImpl(
	    "http://www.m0ep.de/sioc-service-auth#require_authentication",
	    false);
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@1484cfaa has at
     * least one value set
     * 
     * @param model
     *            an RDF2Go model
     ...
     */
    public static boolean hasRequireAuthentication(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	return Base.has(model, instanceResource, REQUIREAUTHENTICATION);
    }
	...
	return Base.has(this.model, this.getResource(), REQUIREAUTHENTICATION);
    }

    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@1484cfaa has
	...
	return Base.hasValue(model, instanceResource, REQUIREAUTHENTICATION,
		value);
    }
    ...
    /**
     * Get all values of property RequireAuthentication as an Iterator over
     * RDF2Go nodes
     * 
     * @param model
     *            an RDF2Go model
     ...
     */
    public static ClosableIterator<org.ontoware.rdf2go.model.node.Node> getAllRequireAuthentication_asNode(
	    Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
    ...
    /**
     * Get all values of property RequireAuthentication as a ReactorResult of
     * RDF2Go nodes
     * 
     * @param model
     *            an RDF2Go model
     ...
     */
    public static ReactorResult<org.ontoware.rdf2go.model.node.Node> getAllRequireAuthentication_asNode_(
	    Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	return Base.getAll_as(model, instanceResource, REQUIREAUTHENTICATION,
     ...
     */
    public ClosableIterator<org.ontoware.rdf2go.model.node.Node> getAllRequireAuthentication_asNode() {
     ...
     */
    public ReactorResult<org.ontoware.rdf2go.model.node.Node> getAllRequireAuthentication_asNode_() {
    ...
    /**
     * Get all values of property RequireAuthentication * @param model an RDF2Go
     * model
     * 
     * @param resource
     *            an RDF2Go resource
     ...
     */
    public static ClosableIterator<Authentication> getAllRequireAuthentication(
	    Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	return Base.getAll(model, instanceResource, REQUIREAUTHENTICATION,
     ...
     */
    public static ReactorResult<Authentication> getAllRequireAuthentication_as(
	    Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	return Base.getAll_as(model, instanceResource, REQUIREAUTHENTICATION,
		Authentication.class);
    ...
    /**
     * Get all values of property RequireAuthentication * @return a
     * ClosableIterator of $type
     * 
     * [Generated from RDFReactor template rule #get12dynamic]
     */
    public ClosableIterator<Authentication> getAllRequireAuthentication() {
	return Base.getAll(this.model, this.getResource(),
		REQUIREAUTHENTICATION, Authentication.class);
    }
     ...
     */
    public ReactorResult<Authentication> getAllRequireAuthentication_as() {
	return Base.getAll_as(this.model, this.getResource(),
		REQUIREAUTHENTICATION, Authentication.class);
    }

    /**
     * Adds a value to property RequireAuthentication as an RDF2Go node
     * 
     * @param model
     *            an RDF2Go model
     * @param resource
     ...
     */
    public static void addRequireAuthentication(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource,
	    org.ontoware.rdf2go.model.node.Node value) {
	Base.add(model, instanceResource, REQUIREAUTHENTICATION, value);
    }
     ...
     */
    public void addRequireAuthentication(
	    org.ontoware.rdf2go.model.node.Node value) {
	Base.add(this.model, this.getResource(), REQUIREAUTHENTICATION, value);
    }

    /**
     * Adds a value to property RequireAuthentication from an instance of
     * Authentication
     * 
     * @param model
     *            an RDF2Go model
     ...
     */
    public void addRequireAuthentication(Authentication value) {
	Base.add(this.model, this.getResource(), REQUIREAUTHENTICATION, value);
    }

    /**
     * Sets a value of property RequireAuthentication from an RDF2Go node.
     ...
     */
    public static void setRequireAuthentication(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource,
	    org.ontoware.rdf2go.model.node.Node value) {
	Base.set(model, instanceResource, REQUIREAUTHENTICATION, value);
    }
    ...
    public void setRequireAuthentication(
	    org.ontoware.rdf2go.model.node.Node value) {
	Base.set(this.model, this.getResource(), REQUIREAUTHENTICATION, value);
    }

    /**
     * Sets a value of property RequireAuthentication from an instance of
     ...
     */
    public void setRequireAuthentication(Authentication value) {
	Base.set(this.model, this.getResource(), REQUIREAUTHENTICATION, value);
    }

    /**
     * Removes a value of property RequireAuthentication as an RDF2Go node
     * 
     * @param model
     *            an RDF2Go model
     * @param resource
     ...
     */
    public static void removeRequireAuthentication(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource,
	    org.ontoware.rdf2go.model.node.Node value) {
	Base.remove(model, instanceResource, REQUIREAUTHENTICATION, value);
    }
     ...
     */
    public void removeRequireAuthentication(
	    org.ontoware.rdf2go.model.node.Node value) {
	Base.remove(this.model, this.getResource(), REQUIREAUTHENTICATION,
		value);
    }

    /**
     * Removes a value of property RequireAuthentication given as an instance of
     * Authentication
     * 
     * @param model
     *            an RDF2Go model
     ...
     */
    public void removeRequireAuthentication(Authentication value) {
	Base.remove(this.model, this.getResource(), REQUIREAUTHENTICATION,
		value);
    }

    /**
     * Removes all values of property RequireAuthentication * @param model an
     * RDF2Go model
     * 
     * @param resource
     *            an RDF2Go resource
     ...
     */
    public static void removeAllRequireAuthentication(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	Base.removeAll(model, instanceResource, REQUIREAUTHENTICATION);
    }

    /**
     * Removes all values of property RequireAuthentication * [Generated from
     * RDFReactor template rule #removeall1dynamic]
     */
    public void removeAllRequireAuthentication() {
	Base.removeAll(this.model, this.getResource(), REQUIREAUTHENTICATION);
    }
}