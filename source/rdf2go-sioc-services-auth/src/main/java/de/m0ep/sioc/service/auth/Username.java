 ...
 */
public class Username extends Credential {
    private static final long serialVersionUID = -6438146703936604752L;

    /** http://www.m0ep.de/sioc-service-auth#Username */
     ...
     */
    protected Username(Model model, URI classURI,
     ...
     */
    public Username(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static Username getInstance(Model model,
     ...
     */
    public static ReactorResult<? extends Username> getAllInstances_as(
	    Model model) {
	return Base.getAllInstances_as(model, RDFS_CLASS, Username.class);
    }

    /**
     * Remove rdf:type Username from this instance. Other triples are not
