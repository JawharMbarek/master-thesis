 ...
 * 12:01 PM
 */
public class APIKey extends Credentials {

    private static final long serialVersionUID = -4060601039727776033L;

    /** http://purl.oclc.org/NET/WebApiAuthentication#APIKey */
    public static final URI RDFS_CLASS = new URIImpl(
            "http://purl.oclc.org/NET/WebApiAuthentication#APIKey", false );
     ...
     */
    protected APIKey( Model model, URI classURI, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public APIKey( Model model, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public APIKey( Model model, String uriString, boolean write ) throws ModelRuntimeException {
     ...
     */
    public APIKey( Model model, BlankNode bnode, boolean write ) {
     ...
     */
    public APIKey( Model model, boolean write ) {
     ...
     *            an RDF2Go resource
     * @return an instance of APIKey or null if none existst
     * 
     *         [Generated from RDFReactor template rule #class0]
     */
    public static APIKey getInstance( Model model, Resource instanceResource ) {
        return Base.getInstance( model, instanceResource, APIKey.class );
    }

    /**
     * Create a new instance of this class in the model. That is, create the statement
     * (instanceResource, RDF.type, http://purl.oclc.org/NET/WebApiAuthentication#APIKey).
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
    ...
    /**
     * Remove triple {@code (this, rdf:type, APIKey)} from this instance. Other triples are not
