 ...
 * 12:01 PM
 */
public class AccessToken extends Credentials {

    private static final long serialVersionUID = 7304732602584485026L;

    /** http://www.m0ep.de/sioc/services/auth#AccessToken */
    public static final URI RDFS_CLASS = new URIImpl(
            "http://www.m0ep.de/sioc/services/auth#AccessToken", false );
     ...
     */
    protected AccessToken( Model model, URI classURI, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public AccessToken( Model model, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public AccessToken( Model model, String uriString, boolean write ) throws ModelRuntimeException {
     ...
     */
    public AccessToken( Model model, BlankNode bnode, boolean write ) {
     ...
     */
    public AccessToken( Model model, boolean write ) {
     ...
     *            an RDF2Go resource
     * @return an instance of AccessToken or null if none existst
     * 
     *         [Generated from RDFReactor template rule #class0]
     */
    public static AccessToken getInstance( Model model, Resource instanceResource ) {
        return Base.getInstance( model, instanceResource, AccessToken.class );
    }

    /**
     * Create a new instance of this class in the model. That is, create the statement
     * (instanceResource, RDF.type, http://www.m0ep.de/sioc/services/auth#AccessToken).
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
    ...
    /**
     * Remove triple {@code (this, rdf:type, AccessToken)} from this instance. Other triples are not
