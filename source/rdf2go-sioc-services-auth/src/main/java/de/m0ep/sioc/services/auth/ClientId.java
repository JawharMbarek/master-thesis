 ...
 * 12:01 PM
 */
public class ClientId extends Credentials {

    private static final long serialVersionUID = -3912615233283785573L;

    /** http://www.m0ep.de/sioc/services/auth#ClientId */
    public static final URI RDFS_CLASS = new URIImpl(
            "http://www.m0ep.de/sioc/services/auth#ClientId", false );
     ...
     */
    protected ClientId( Model model, URI classURI, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public ClientId( Model model, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public ClientId( Model model, String uriString, boolean write ) throws ModelRuntimeException {
     ...
     */
    public ClientId( Model model, BlankNode bnode, boolean write ) {
     ...
     */
    public ClientId( Model model, boolean write ) {
     ...
     *            an RDF2Go resource
     * @return an instance of ClientId or null if none existst
     * 
     *         [Generated from RDFReactor template rule #class0]
     */
    public static ClientId getInstance( Model model, Resource instanceResource ) {
        return Base.getInstance( model, instanceResource, ClientId.class );
    }

    /**
     * Create a new instance of this class in the model. That is, create the statement
     * (instanceResource, RDF.type, http://www.m0ep.de/sioc/services/auth#ClientId).
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
    ...
    /**
     * Remove triple {@code (this, rdf:type, ClientId)} from this instance. Other triples are not
