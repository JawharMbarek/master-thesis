 ...
 * 12:01 PM
 */
public class Direct extends AuthenticationMechanism {

    private static final long serialVersionUID = -6729291897479430759L;

    /** http://purl.oclc.org/NET/WebApiAuthentication#Direct */
    public static final URI RDFS_CLASS = new URIImpl(
            "http://purl.oclc.org/NET/WebApiAuthentication#Direct", false );
     ...
     */
    protected Direct( Model model, URI classURI, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public Direct( Model model, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public Direct( Model model, String uriString, boolean write ) throws ModelRuntimeException {
     ...
     */
    public Direct( Model model, BlankNode bnode, boolean write ) {
     ...
     */
    public Direct( Model model, boolean write ) {
     ...
     *            an RDF2Go resource
     * @return an instance of Direct or null if none existst
     * 
     *         [Generated from RDFReactor template rule #class0]
     */
    public static Direct getInstance( Model model, Resource instanceResource ) {
        return Base.getInstance( model, instanceResource, Direct.class );
    }

    /**
     * Create a new instance of this class in the model. That is, create the statement
     * (instanceResource, RDF.type, http://purl.oclc.org/NET/WebApiAuthentication#Direct).
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
    ...
    /**
     * Remove triple {@code (this, rdf:type, Direct)} from this instance. Other triples are not
