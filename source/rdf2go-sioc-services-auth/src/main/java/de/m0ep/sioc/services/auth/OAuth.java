 ...
 * 12:01 PM
 */
public class OAuth extends AuthenticationMechanism {

    private static final long serialVersionUID = -8618811046091151951L;

    /** http://purl.oclc.org/NET/WebApiAuthentication#OAuth */
    public static final URI RDFS_CLASS = new URIImpl(
            "http://purl.oclc.org/NET/WebApiAuthentication#OAuth", false );
     ...
     */
    protected OAuth( Model model, URI classURI, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public OAuth( Model model, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public OAuth( Model model, String uriString, boolean write ) throws ModelRuntimeException {
     ...
     */
    public static OAuth getInstance( Model model, Resource instanceResource ) {
     ...
     * (instanceResource, RDF.type, http://purl.oclc.org/NET/WebApiAuthentication#OAuth).
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
    ...
    /**
     * Remove triple {@code (this, rdf:type, OAuth)} from this instance. Other triples are not
