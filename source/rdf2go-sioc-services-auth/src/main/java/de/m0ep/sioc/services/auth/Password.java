...
public class Password extends Credentials {
    ...
    private static final long serialVersionUID = -5525439376211053555L;

    /** http://purl.oclc.org/NET/WebApiAuthentication#Password */
    public static final URI RDFS_CLASS = new URIImpl(
            "http://purl.oclc.org/NET/WebApiAuthentication#Password", false );
     ...
     */
    protected Password( Model model, URI classURI, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public Password( Model model, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public Password( Model model, String uriString, boolean write ) throws ModelRuntimeException {
     ...
     */
    public Password( Model model, BlankNode bnode, boolean write ) {
     ...
     */
    public Password( Model model, boolean write ) {
     ...
     *            an RDF2Go resource
     * @return an instance of Password or null if none existst
     * 
     *         [Generated from RDFReactor template rule #class0]
     */
    public static Password getInstance( Model model, Resource instanceResource ) {
        return Base.getInstance( model, instanceResource, Password.class );
    }

    /**
     * Create a new instance of this class in the model. That is, create the statement
     * (instanceResource, RDF.type, http://purl.oclc.org/NET/WebApiAuthentication#Password).
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
    ...
    /**
     * Remove triple {@code (this, rdf:type, Password)} from this instance. Other triples are not
