 ...
 * 12:01 PM
 */
public class RefreshToken extends Credentials {

    private static final long serialVersionUID = 4872630689198899537L;

    /** http://www.m0ep.de/sioc/services/auth#RefreshToken */
    public static final URI RDFS_CLASS = new URIImpl(
            "http://www.m0ep.de/sioc/services/auth#RefreshToken", false );
     ...
     */
    protected RefreshToken( Model model, URI classURI, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public RefreshToken( Model model, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public RefreshToken( Model model, String uriString, boolean write )
            throws ModelRuntimeException {
     ...
     */
    public RefreshToken( Model model, BlankNode bnode, boolean write ) {
     ...
     */
    public RefreshToken( Model model, boolean write ) {
     ...
     *            an RDF2Go resource
     * @return an instance of RefreshToken or null if none existst
     * 
     *         [Generated from RDFReactor template rule #class0]
     */
    public static RefreshToken getInstance( Model model, Resource instanceResource ) {
        return Base.getInstance( model, instanceResource, RefreshToken.class );
    }

    /**
     * Create a new instance of this class in the model. That is, create the statement
     * (instanceResource, RDF.type, http://www.m0ep.de/sioc/services/auth#RefreshToken).
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
    ...
    /**
     * Remove triple {@code (this, rdf:type, RefreshToken)} from this instance. Other triples are
