...
public class Username extends Credentials {
    ...
    private static final long serialVersionUID = -3432936095270094815L;

    /** http://purl.oclc.org/NET/WebApiAuthentication#Username */
    public static final URI RDFS_CLASS = new URIImpl(
            "http://purl.oclc.org/NET/WebApiAuthentication#Username", false );
     ...
     */
    protected Username( Model model, URI classURI, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public Username( Model model, Resource instanceIdentifier, boolean write ) {
     ...
     */
    public Username( Model model, String uriString, boolean write ) throws ModelRuntimeException {
     ...
     */
    public Username( Model model, BlankNode bnode, boolean write ) {
     ...
     */
    public Username( Model model, boolean write ) {
     ...
     *            an RDF2Go resource
     * @return an instance of Username or null if none existst
     * 
     *         [Generated from RDFReactor template rule #class0]
     */
    public static Username getInstance( Model model, Resource instanceResource ) {
        return Base.getInstance( model, instanceResource, Username.class );
    }

    /**
     * Create a new instance of this class in the model. That is, create the statement
     * (instanceResource, RDF.type, http://purl.oclc.org/NET/WebApiAuthentication#Username).
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
    ...
    /**
     * Remove triple {@code (this, rdf:type, Username)} from this instance. Other triples are not
