...
public class Role extends Thing {
    ...
    public static final URI RDFS_CLASS = new URIImpl(
	    "http://rdfs.org/sioc/ns#Role", false);

    /** http://rdfs.org/sioc/ns#function_of */
    public static final URI FUNCTIONOF = new URIImpl(
	    "http://rdfs.org/sioc/ns#function_of", false);

    /** http://rdfs.org/sioc/ns#has_scope */
    public static final URI SCOPE = new URIImpl(
     ...
     */
    protected Role(Model model, URI classURI,
     ...
     */
    public Role(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static Role getInstance(Model model,
     ...
     * statement (instanceResource, RDF.type, http://rdfs.org/sioc/ns#Role).
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
     ...
     *            an RDF2Go model
     * @param objectValue
     * @return all A's as RDF resources, that have a relation 'Function' to this
     *         Role instance
     * 
     *         [Generated from RDFReactor template rule #getallinverse1static]
     */
    public static ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllFunction_Inverse(
	...
	return Base.getAll_Inverse(this.model, Thing.FUNCTION,
		this.getResource());
    }
	...
	return Base.getAll_Inverse(this.model, Thing.SCOPEOF,
		this.getResource());
    }

    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@61e076f3 has at
     * least one value set
     * 
     * @param model
     *            an RDF2Go model
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@61e076f3 has
     ...
     */
    public static ClosableIterator<Thing> getAllFunctionOf(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	return Base
		.getAll(model, instanceResource, FUNCTIONOF, Thing.class);
    }
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@5f015823 has at
     * least one value set
     * 
     * @param model
     *            an RDF2Go model
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@5f015823 has
     * the given value (maybe among other values).
     * 
     * @param model
     *            an RDF2Go model
     ...
     *         [Generated from RDFReactor template rule #get11static]
     */
    public static ClosableIterator<Thing> getAllScopes(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
     ...
     * [Generated from RDFReactor template rule #get12dynamic]
     */
    public ClosableIterator<Thing> getAllScopes() {
    ...
    /**
     * Sets a value of property Scope from an RDF2Go node. First, all existing
    ...
    /**
     * Sets a value of property Scope from an instance of Thing First, all
     * existing values are removed, then this value is added. Cardinality
     * constraints are not checked, but this method exists only for properties
     * with no minCardinality or minCardinality == 1.
     * 
