...
public class Thread extends Container {
     ...
     */
    protected Thread(Model model, URI classURI,
     ...
     */
    public Thread(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static Thread getInstance(Model model,
     ...
     * statement (instanceResource, RDF.type, http://rdfs.org/sioc/ns#Thread).
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
    ...
    /**
     * Remove rdf:type Thread from this instance. Other triples are not
