...
public class Usergroup extends SIOCThing {
     ...
     */
    public static ReactorResult<? extends Usergroup> getAllInstances_as(
	    Model model) {
     ...
     *            an RDF2Go model
     * @param objectValue
     * @return all A's as a ReactorResult, that have a relation 'Memberof' to
     *         this Usergroup instance
     * 
     *         [Generated from RDFReactor template rule
     *         #getallinverse-as1static]
     */
    public static ReactorResult<org.ontoware.rdf2go.model.node.Resource> getAllMemberof_Inverse_as(
	    Model model, Object objectValue) {
	return Base.getAll_Inverse_as(model, UserAccount.MEMBEROF, objectValue,
		org.ontoware.rdf2go.model.node.Resource.class);
    }
     ...
     *            an RDF2Go model
     * @param objectValue
     * @return all A's as a ReactorResult, that have a relation 'Usergroup' to
     *         this Usergroup instance
     * 
     *         [Generated from RDFReactor template rule
     *         #getallinverse-as1static]
     */
    public static ReactorResult<org.ontoware.rdf2go.model.node.Resource> getAllUsergroup_Inverse_as(
	    Model model, Object objectValue) {
	return Base.getAll_Inverse_as(model, Space.USERGROUP, objectValue,
		org.ontoware.rdf2go.model.node.Resource.class);
    }
     ...
     */
    public static ReactorResult<org.ontoware.rdf2go.model.node.Node> getAllUsergroupMember_asNode_(
	    Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	return Base.getAll_as(model, instanceResource, MEMBER,
     ...
     */
    public ReactorResult<org.ontoware.rdf2go.model.node.Node> getAllUsergroupMember_asNode_() {
     ...
     *         #get7static-reactor-result]
     */
    public static ReactorResult<org.ontoware.rdf2go.model.node.Node> getAllUsergroupof_asNode_(
	    Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	return Base.getAll_as(model, instanceResource, USERGROUPOF,
		org.ontoware.rdf2go.model.node.Node.class);
    }
    ...
    public static ReactorResult<Space> getAllUsergroupof_as(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	return Base
		.getAll_as(model, instanceResource, USERGROUPOF, Space.class);
    }
