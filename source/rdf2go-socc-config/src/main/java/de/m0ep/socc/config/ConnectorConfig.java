...
public class ConnectorConfig extends OwlThing {
    ...
    public static final URI CONNECTORCLASS = new URIImpl(
            "http://www.m0ep.de/socc/config#connectorClass", false );
    ...
    public static final URI[] MANAGED_URIS = {
            new URIImpl( "http://www.m0ep.de/socc/config#connectorClass", false ),
     ...
     * (instanceResource, RDF.type, http://www.m0ep.de/socc/config#ConnectorConfig).
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
    ...
    /**
     * Remove triple {@code (this, rdf:type, ConnectorConfig)} from this instance. Other triples are
     ...
     *         [Generated from RDFReactor template rule #get12dynamic]
     */
    public static String getConnectorClass( Model model, Resource instanceResource ) {
    ...
    /**
     * Check if {@code DefaultUserAccount} has the given value (maybe among other values).
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
    ...
    /**
     * Get all values of property {@code DefaultUserAccount} as an Iterator over RDF2Go nodes.
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
    ...
    /**
     * Adds a value to property {@code DefaultUserAccount} as an RDF2Go {@linkplain Node}.
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
    ...
    /**
     * Sets a value of property {@code DefaultUserAccount} from an RDF2Go {@linkplain Node}. First,
     ...
     * {@linkplain UserAccount}. First, all existing values are removed, then this value is added.
     * Cardinality constraints are not checked, but this method exists only for properties with no
     * {@code minCardinality} or {@code minCardinality == 1}.
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
    ...
    /**
     * Removes a value of property {@code DefaultUserAccount} as an RDF2Go {@linkplain Node}.
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
    ...
    /**
     * Removes a value of property {@code DefaultUserAccount} given as an instance of
     * {@linkplain UserAccount}.
     * 
     * @param model
     *            an RDF2Go model
