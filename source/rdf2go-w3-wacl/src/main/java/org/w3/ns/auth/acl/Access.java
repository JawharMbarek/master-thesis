 ...
 */
public class Access extends Thing {
    private static final long serialVersionUID = 7040638135537915320L;

    /** http://www.w3.org/ns/auth/acl#Access */
    public static final URI RDFS_CLASS = new URIImpl(
            "http://www.w3.org/ns/auth/acl#Access", false);
     ...
     */
    protected Access(Model model, URI classURI,
     ...
     */
    public Access(Model model, String uriString, boolean write)
     ...
     */
    public Access(Model model, BlankNode bnode, boolean write) {
     ...
     */
    public Access(Model model, boolean write) {
     ...
     * @return an instance of Access or null if none existst [Generated from
     *         RDFReactor template rule #class0]
     */
    public static Access getInstance(Model model,
            org.ontoware.rdf2go.model.node.Resource instanceResource) {
        return Base.getInstance(model, instanceResource, Access.class);
    }
     ...
     */
    public static ReactorResult<? extends Access> getAllInstances_as(Model model) {
        return Base.getAllInstances_as(model, RDFS_CLASS, Access.class);
    }

    /**
     * Remove rdf:type Access from this instance. Other triples are not
