 ...
 */
public class Authorization extends ACLThing {
     ...
     *            an RDF2Go resource
     * @return an instance of Authorization or null if none existst
     * 
     ...
     *         [Generated from RDFReactor template rule #get11static]
     */
    public static ClosableIterator<ACLThing> getAllDefaultAccessForNew(
	    Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	return Base.getAll(model, instanceResource,
		DEFAULT_ACCESS_FOR_NEW, ACLThing.class);
    }
     ...
     * [Generated from RDFReactor template rule #get12dynamic]
     */
    public ClosableIterator<ACLThing> getAllDefaultAccessForNew() {
     ...
     * [Generated from RDFReactor template rule #get12dynamic]
     */
    public ACLThing getDefaultAccessForNew() {
	return Base.getAll_as(this.model, this.getResource(),
		DEFAULT_ACCESS_FOR_NEW, ACLThing.class).firstValue();
    }
     ...
     * [Generated from RDFReactor template rule #add4dynamic]
     */
    public void addDefaultAccessForNew(ACLThing value) {
	Base.add(this.model, this.getResource(), DEFAULT_ACCESS_FOR_NEW,
		value);
    }
     ...
     *            [Generated from RDFReactor template rule #set4dynamic]
     */
    public void setDefaultAccessForNew(ACLThing value) {
	Base.set(this.model, this.getResource(), DEFAULT_ACCESS_FOR_NEW,
		value);
    }
     ...
     *            [Generated from RDFReactor template rule #remove4dynamic]
     */
    public void removeDefaultAccessForNew(ACLThing value) {
	Base.remove(this.model, this.getResource(),
		DEFAULT_ACCESS_FOR_NEW, value);
    }
