...
public class Control extends Access {
    private static final long serialVersionUID = 87005707514402171L;
     ...
     */
    protected Control(Model model, URI classURI,
     ...
     */
    public Control(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public Control(Model model, BlankNode bnode, boolean write) {
     ...
     */
    public Control(Model model, boolean write) {
     ...
     *            an RDF2Go resource
     * @return an instance of Control or null if none existst
     * 
     *         [Generated from RDFReactor template rule #class0]
     */
    public static Control getInstance(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	return Base.getInstance(model, instanceResource, Control.class);
    }
     ...
     */
    public static ReactorResult<? extends Control> getAllInstances_as(
	    Model model) {
	return Base.getAllInstances_as(model, RDFS_CLASS, Control.class);
    }

    /**
     * Remove rdf:type Control from this instance. Other triples are not
