 ...
 */
public class Read extends Access {
    private static final long serialVersionUID = 9086087622957072322L;

    /** http://www.w3.org/ns/auth/acl#Read */
    public static final URI RDFS_CLASS = new URIImpl(
	    "http://www.w3.org/ns/auth/acl#Read", false);
     ...
     */
    protected Read(Model model, URI classURI,
     ...
     */
    public Read(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public Read(Model model, BlankNode bnode, boolean write) {
     ...
     */
    public Read(Model model, boolean write) {
     ...
     *            an RDF2Go resource
     * @return an instance of Read or null if none existst
     * 
     *         [Generated from RDFReactor template rule #class0]
     */
    public static Read getInstance(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	return Base.getInstance(model, instanceResource, Read.class);
    }
     ...
     */
    public static ReactorResult<? extends Read> getAllInstances_as(Model model) {
	return Base.getAllInstances_as(model, RDFS_CLASS, Read.class);
    }

    /**
     * Remove rdf:type Read from this instance. Other triples are not affected.
