...
/**
 * Implementation of {@link de.m0ep.uni.ma.rdfs.foaf.Agent}
 * Use the de.m0ep.uni.ma.rdfs.foaf.Factory to create instances of this class.
 * <p>(URI: http://xmlns.com/foaf/0.1/Agent)</p>
 * <br>
 */
public class AgentImpl extends com.ibm.adtech.jastor.ThingImpl implements de.m0ep.uni.ma.rdfs.foaf.Agent {
	...
	public com.hp.hpl.jena.rdf.model.Literal getAge() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": age getProperty() in de.m0ep.uni.ma.rdfs.foaf.Agent model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		age = literal;
		return literal;
	}
	...
	public com.hp.hpl.jena.rdf.model.Literal getGender() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": gender getProperty() in de.m0ep.uni.ma.rdfs.foaf.Agent model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		gender = literal;
		return literal;
	}
	...
	private void initNick() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/nick properties in Agent model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			nick.add(literal);
		}
	}
	...
	private void initLogo() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/logo properties in Agent model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initOpenid() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/openid properties in Agent model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public com.hp.hpl.jena.rdf.model.Literal getBirthday() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": birthday getProperty() in de.m0ep.uni.ma.rdfs.foaf.Agent model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		birthday = literal;
		return literal;
	}
	...
	private void initHomepage() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/homepage properties in Agent model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initYahooChatID() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/yahooChatID properties in Agent model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initTheme() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/theme properties in Agent model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initTopic__interest() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/topic_interest properties in Agent model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initInterest() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/interest properties in Agent model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initTipjar() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/tipjar properties in Agent model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFundedBy.iterator();iter.hasNext();){
							...
							listener.fundedByAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_fundedBy);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMbox.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.mboxAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_mbox);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.nameAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(dnaChecksumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDnaChecksum.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.dnaChecksumAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(ageProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.ageChanged(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPhone.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.phoneAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_phone);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(genderProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.genderChanged(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPage.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.pageAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_page);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nickProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNick.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.nickAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLogo.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.logoAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_logo);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForWeblog.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.weblogAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_weblog);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMaker.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.makerAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_maker);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(givennameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForGivenname.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.givennameAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccount.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.accountAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_account);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForOpenid.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.openidAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_openid);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.titleAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(birthdayProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.birthdayChanged(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomepage.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.homepageAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_homepage);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(yahooChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForYahooChatID.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.yahooChatIDAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(icqChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForIcqChatID.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.icqChatIDAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHoldsAccount.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.holdsAccountAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_holdsAccount);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTheme.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.themeAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_theme);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMade.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.madeAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_made);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(mbox__sha1sumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMbox__sha1sum.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.mbox__sha1sumAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic__interest.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.topic__interestAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_topic__interest);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForInterest.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.interestAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_interest);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(aimChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAimChatID.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.aimChatIDAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(skypeIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForSkypeID.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.skypeIDAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTipjar.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.tipjarAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_tipjar);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(statusProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForStatus.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.statusAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(jabberIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForJabberID.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.jabberIDAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(msnChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMsnChatID.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.msnChatIDAdded(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(fundedByProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFundedBy.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.fundedByRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_fundedBy);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(mboxProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMbox.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.mboxRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_mbox);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.nameRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(dnaChecksumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDnaChecksum.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.dnaChecksumRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(phoneProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPhone.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.phoneRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_phone);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(pageProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPage.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.pageRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_page);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nickProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNick.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.nickRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(logoProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLogo.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.logoRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_logo);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(weblogProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForWeblog.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.weblogRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_weblog);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(makerProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMaker.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.makerRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_maker);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(givennameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForGivenname.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.givennameRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(accountProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccount.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.accountRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_account);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(openidProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForOpenid.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.openidRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_openid);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.titleRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(homepageProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomepage.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.homepageRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_homepage);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(yahooChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForYahooChatID.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.yahooChatIDRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(icqChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForIcqChatID.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.icqChatIDRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(holdsAccountProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHoldsAccount.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.holdsAccountRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_holdsAccount);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(themeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTheme.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.themeRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_theme);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(madeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMade.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.madeRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_made);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(mbox__sha1sumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMbox__sha1sum.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.mbox__sha1sumRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(topic__interestProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic__interest.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.topic__interestRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_topic__interest);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(interestProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForInterest.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.interestRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_interest);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(aimChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAimChatID.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.aimChatIDRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(skypeIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForSkypeID.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.skypeIDRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(tipjarProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTipjar.iterator();iter.hasNext();){
							AgentListener listener=(AgentListener)iter.next();
							listener.tipjarRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,_tipjar);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(statusProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForStatus.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.statusRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(jabberIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForJabberID.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.jabberIDRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(msnChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMsnChatID.iterator();iter.hasNext();){
						AgentListener listener=(AgentListener)iter.next();
						listener.msnChatIDRemoved(de.m0ep.uni.ma.rdfs.foaf.AgentImpl.this,literal);
					}
				}
				return;
			}
