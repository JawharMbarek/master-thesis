...
/**
 * Implementation of {@link de.m0ep.uni.ma.rdfs.foaf.Organization}
 * Use the de.m0ep.uni.ma.rdfs.foaf.Factory to create instances of this class.
 * <p>(URI: http://xmlns.com/foaf/0.1/Organization)</p>
 * <br>
 */
public class OrganizationImpl extends com.ibm.adtech.jastor.ThingImpl implements de.m0ep.uni.ma.rdfs.foaf.Organization {
	...
	OrganizationImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static OrganizationImpl getOrganization(Resource resource, Model model) throws JastorException {
		return new OrganizationImpl(resource, model);
	}
	    
	static OrganizationImpl createOrganization(Resource resource, Model model) throws JastorException { 
		OrganizationImpl impl = new OrganizationImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, Organization.TYPE)))
			impl._model.add(impl._resource, RDF.type, Organization.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, de.m0ep.uni.ma.rdfs.foaf.Organization.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initFundedBy() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/fundedBy properties in Organization model not a Resource", stmt.getObject());
	...
	private void initMbox() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/mbox properties in Organization model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/name properties in Organization model not a Literal", stmt.getObject());
	...
	private void initDnaChecksum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/dnaChecksum properties in Organization model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public com.hp.hpl.jena.rdf.model.Literal getAge() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": age getProperty() in de.m0ep.uni.ma.rdfs.foaf.Organization model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		age = literal;
		return literal;
	}
	...
	private void initPhone() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/phone properties in Organization model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public com.hp.hpl.jena.rdf.model.Literal getGender() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": gender getProperty() in de.m0ep.uni.ma.rdfs.foaf.Organization model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		gender = literal;
		return literal;
	}
	...
	private void initPage() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/page properties in Organization model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initNick() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/nick properties in Organization model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			nick.add(literal);
		}
	}
	...
	private void initLogo() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/logo properties in Organization model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initWeblog() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/weblog properties in Organization model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initMaker() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/maker properties in Organization model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initGivenname() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/givenname properties in Organization model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initAccount() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/account properties in Organization model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initOpenid() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/openid properties in Organization model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initTitle() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/title properties in Organization model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			title.add(literal);
		}
	}
	...
	public com.hp.hpl.jena.rdf.model.Literal getBirthday() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": birthday getProperty() in de.m0ep.uni.ma.rdfs.foaf.Organization model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		birthday = literal;
		return literal;
	}
	...
	private void initHomepage() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/homepage properties in Organization model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initYahooChatID() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/yahooChatID properties in Organization model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initIcqChatID() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/icqChatID properties in Organization model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHoldsAccount() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/holdsAccount properties in Organization model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initTheme() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/theme properties in Organization model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initMade() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/made properties in Organization model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initMbox__sha1sum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/mbox_sha1sum properties in Organization model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initTopic__interest() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/topic_interest properties in Organization model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initInterest() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/interest properties in Organization model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initAimChatID() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/aimChatID properties in Organization model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initSkypeID() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/skypeID properties in Organization model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			skypeID.add(literal);
		}
	}
	...
	private void initTipjar() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/tipjar properties in Organization model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initStatus() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/status properties in Organization model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			status.add(literal);
		}
	}
	...
	private void initJabberID() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/jabberID properties in Organization model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initMsnChatID() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/msnChatID properties in Organization model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof OrganizationListener))
			throw new IllegalArgumentException("ThingListener must be instance of OrganizationListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((OrganizationListener)listener);
		}
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFundedBy.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.fundedByAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_fundedBy);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMbox.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.mboxAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_mbox);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.nameAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(dnaChecksumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDnaChecksum.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.dnaChecksumAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(ageProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.ageChanged(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPhone.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.phoneAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_phone);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(genderProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.genderChanged(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPage.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.pageAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_page);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nickProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNick.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.nickAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLogo.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.logoAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_logo);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForWeblog.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.weblogAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_weblog);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMaker.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.makerAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_maker);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(givennameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForGivenname.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.givennameAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccount.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.accountAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_account);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForOpenid.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.openidAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_openid);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.titleAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(birthdayProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.birthdayChanged(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomepage.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.homepageAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_homepage);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(yahooChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForYahooChatID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.yahooChatIDAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(icqChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForIcqChatID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.icqChatIDAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHoldsAccount.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.holdsAccountAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_holdsAccount);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTheme.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.themeAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_theme);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMade.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.madeAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_made);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(mbox__sha1sumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMbox__sha1sum.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.mbox__sha1sumAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic__interest.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.topic__interestAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_topic__interest);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForInterest.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.interestAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_interest);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(aimChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAimChatID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.aimChatIDAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(skypeIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForSkypeID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.skypeIDAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTipjar.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.tipjarAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_tipjar);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(statusProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForStatus.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.statusAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(jabberIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForJabberID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.jabberIDAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(msnChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMsnChatID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.msnChatIDAdded(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(fundedByProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFundedBy.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.fundedByRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_fundedBy);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(mboxProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMbox.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.mboxRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_mbox);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.nameRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(dnaChecksumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDnaChecksum.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.dnaChecksumRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(phoneProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPhone.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.phoneRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_phone);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(pageProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPage.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.pageRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_page);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nickProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNick.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.nickRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(logoProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLogo.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.logoRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_logo);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(weblogProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForWeblog.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.weblogRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_weblog);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(makerProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMaker.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.makerRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_maker);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(givennameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForGivenname.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.givennameRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(accountProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccount.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.accountRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_account);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(openidProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForOpenid.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.openidRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_openid);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.titleRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(homepageProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHomepage.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.homepageRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_homepage);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(yahooChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForYahooChatID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.yahooChatIDRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(icqChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForIcqChatID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.icqChatIDRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(holdsAccountProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHoldsAccount.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.holdsAccountRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_holdsAccount);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(themeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTheme.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.themeRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_theme);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(madeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMade.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.madeRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_made);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(mbox__sha1sumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMbox__sha1sum.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.mbox__sha1sumRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(topic__interestProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic__interest.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.topic__interestRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_topic__interest);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(interestProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForInterest.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.interestRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_interest);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(aimChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAimChatID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.aimChatIDRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(skypeIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForSkypeID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.skypeIDRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(tipjarProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTipjar.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.tipjarRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,_tipjar);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(statusProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForStatus.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.statusRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(jabberIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForJabberID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.jabberIDRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(msnChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMsnChatID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.msnChatIDRemoved(de.m0ep.uni.ma.rdfs.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
