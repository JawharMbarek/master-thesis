...
/**
 * Implementation of {@link de.m0ep.uni.ma.rdfs.sioc.Forum}
 * Use the de.m0ep.uni.ma.rdfs.sioc.Factory to create instances of this class.
 * <p>(URI: http://rdfs.org/sioc/ns#Forum)</p>
 * <br>
 */
public class ForumImpl extends com.ibm.adtech.jastor.ThingImpl implements de.m0ep.uni.ma.rdfs.sioc.Forum {
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, de.m0ep.uni.ma.rdfs.sioc.Forum.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initHas__host() throws JastorException {
		...
		while(it.hasNext()) {
			...
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				de.m0ep.uni.ma.rdfs.sioc.Site has__host = de.m0ep.uni.ma.rdfs.sioc.Factory.getSite(resource,_model);
	...
	public void addHas__host(de.m0ep.uni.ma.rdfs.sioc.Site has__host) throws JastorException {
	...
	public de.m0ep.uni.ma.rdfs.sioc.Site addHas__host() throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.Site has__host = de.m0ep.uni.ma.rdfs.sioc.Factory.createSite(_model.createResource(),_model);
		if (this.has__host == null)
			initHas__host();
		this.has__host.add(has__host);
		_model.add(_model.createStatement(_resource,has__hostProperty,has__host.resource()));
	...
	public de.m0ep.uni.ma.rdfs.sioc.Site addHas__host(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.Site has__host = de.m0ep.uni.ma.rdfs.sioc.Factory.getSite(resource,_model);
		if (this.has__host == null)
			initHas__host();
		if (this.has__host.contains(has__host))
	...
	public void removeHas__host(de.m0ep.uni.ma.rdfs.sioc.Site has__host) throws JastorException {
		if (this.has__host == null)
			initHas__host();
		if (!this.has__host.contains(has__host))
			return;
	...
	private void initHas__moderator() throws JastorException {
		...
		while(it.hasNext()) {
			...
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				de.m0ep.uni.ma.rdfs.sioc.UserAccount has__moderator = de.m0ep.uni.ma.rdfs.sioc.Factory.getUserAccount(resource,_model);
	...
	public void addHas__moderator(de.m0ep.uni.ma.rdfs.sioc.UserAccount has__moderator) throws JastorException {
	...
	public de.m0ep.uni.ma.rdfs.sioc.UserAccount addHas__moderator() throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.UserAccount has__moderator = de.m0ep.uni.ma.rdfs.sioc.Factory.createUserAccount(_model.createResource(),_model);
		if (this.has__moderator == null)
			initHas__moderator();
		this.has__moderator.add(has__moderator);
		_model.add(_model.createStatement(_resource,has__moderatorProperty,has__moderator.resource()));
	...
	public de.m0ep.uni.ma.rdfs.sioc.UserAccount addHas__moderator(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		de.m0ep.uni.ma.rdfs.sioc.UserAccount has__moderator = de.m0ep.uni.ma.rdfs.sioc.Factory.getUserAccount(resource,_model);
		if (this.has__moderator == null)
			initHas__moderator();
		if (this.has__moderator.contains(has__moderator))
	...
	public void removeHas__moderator(de.m0ep.uni.ma.rdfs.sioc.UserAccount has__moderator) throws JastorException {
		if (this.has__moderator == null)
			initHas__moderator();
		if (!this.has__moderator.contains(has__moderator))
			return;
	...
	public void unregisterListener(ThingListener listener) {
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLink.iterator();iter.hasNext();){
							...
							listener.linkAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_link);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(noteProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNote.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.noteAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__itemsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__items.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.num__itemsAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__creator.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.has__creatorAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_has__creator);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__owner.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.has__ownerAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_has__owner);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDescription.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.descriptionAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__parent.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.has__parentAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_has__parent);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForContainer__of.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.container__ofAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_container__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubject.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.subjectAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_subject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__authorsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__authors.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.num__authorsAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__viewsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__views.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.num__viewsAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReferences.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.referencesAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_references);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.topicAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_topic);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__activity__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__activity__date.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.last__activity__dateAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__subscriber.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.has__subscriberAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_has__subscriber);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(idProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForId.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.idAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(last__item__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__item__date.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.last__item__dateAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLinks__to.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.links__toAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_links__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__reply__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__reply__date.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.last__reply__dateAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__repliesProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__replies.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.num__repliesAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__function.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.has__functionAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_has__function);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParent__of.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.parent__ofAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_parent__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.nameAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__space.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.has__spaceAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_has__space);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRelated__to.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.related__toAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_related__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDate.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.dateAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.titleAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForScope__of.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.scope__ofAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_scope__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeed.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.feedAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_feed);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.depictionAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_depiction);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__hostProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					de.m0ep.uni.ma.rdfs.sioc.Site _has__host = null;
					try {
						_has__host = de.m0ep.uni.ma.rdfs.sioc.Factory.getSite(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__host == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__host.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.has__hostAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_has__host);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__threadsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__threads.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.num__threadsAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__moderatorProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					de.m0ep.uni.ma.rdfs.sioc.UserAccount _has__moderator = null;
					try {
						_has__moderator = de.m0ep.uni.ma.rdfs.sioc.Factory.getUserAccount(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__moderator == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__moderator.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.has__moderatorAdded(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_has__moderator);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(linkProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLink.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.linkRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_link);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(noteProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNote.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.noteRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__itemsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.num__itemsRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__creatorProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__creator.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.has__creatorRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_has__creator);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__ownerProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__owner.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.has__ownerRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_has__owner);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDescription.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.descriptionRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__parentProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__parent.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.has__parentRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_has__parent);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(container__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForContainer__of.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.container__ofRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_container__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(subjectProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubject.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.subjectRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_subject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__authorsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.num__authorsRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__viewsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.num__viewsRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(referencesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReferences.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.referencesRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_references);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(topicProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.topicRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_topic);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__activity__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__activity__date.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.last__activity__dateRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__subscriberProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__subscriber.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.has__subscriberRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_has__subscriber);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(idProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForId.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.idRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(last__item__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__item__date.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.last__item__dateRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(links__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLinks__to.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.links__toRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_links__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__reply__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__reply__date.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.last__reply__dateRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__repliesProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.num__repliesRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__functionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__function.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.has__functionRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_has__function);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(parent__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParent__of.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.parent__ofRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_parent__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.nameRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__spaceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__space.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.has__spaceRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_has__space);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(related__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRelated__to.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.related__toRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_related__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDate.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.dateRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.titleRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(scope__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForScope__of.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.scope__ofRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_scope__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(feedProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeed.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.feedRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_feed);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(depictionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.depictionRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_depiction);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__host != null) {
						...
						for (int i=0;i<has__host.size();i++) {
							de.m0ep.uni.ma.rdfs.sioc.Site __item = (de.m0ep.uni.ma.rdfs.sioc.Site) has__host.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__host = __item;
								break;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__host.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.has__hostRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_has__host);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__threadsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ForumListener listener=(ForumListener)iter.next();
						listener.num__threadsRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__moderator != null) {
						...
						for (int i=0;i<has__moderator.size();i++) {
							de.m0ep.uni.ma.rdfs.sioc.UserAccount __item = (de.m0ep.uni.ma.rdfs.sioc.UserAccount) has__moderator.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__moderator.iterator();iter.hasNext();){
							ForumListener listener=(ForumListener)iter.next();
							listener.has__moderatorRemoved(de.m0ep.uni.ma.rdfs.sioc.ForumImpl.this,_has__moderator);
						}
					}
				}
				return;
