 ...
 */
public class Community extends SIOCThing {
     ...
     */
    protected Community(Model model, URI classURI,
     ...
     */
    public Community(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public Community(Model model, BlankNode bnode, boolean write) {
     ...
     */
    public Community(Model model, boolean write) {
     ...
     */
    public static Community getInstance(Model model,
	    org.ontoware.rdf2go.model.node.Resource instanceResource) {
	return Base.getInstance(model, instanceResource, Community.class);
    }
     ...
     */
    public static ReactorResult<? extends Community> getAllInstances_as(
	    Model model) {
	return Base.getAllInstances_as(model, RDFS_CLASS, Community.class);
    }
     ...
     *            an RDF2Go model
     * @param objectValue
     * @return all A's as RDF resources, that have a relation 'Embedsknowledge'
     *         to this Graph instance
     * 
