...
public class Graph extends SIOCThing {
    ...
    public static final URI RDFS_CLASS = new URIImpl(
	    "http://www.w3.org/2004/03/trix/rdfg-1/Graph", false);
     ...
     */
    protected Graph(Model model, URI classURI,
     ...
     */
    public Graph(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static Graph getInstance(Model model,
