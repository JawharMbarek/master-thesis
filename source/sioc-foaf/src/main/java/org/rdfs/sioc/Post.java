...
public class Post extends Item {
     ...
     * 
     */
    private static final long serialVersionUID = 3173427033111132393L;

    /** http://rdfs.org/sioc/ns#Post */
    public static final URI RDFS_CLASS = new URIImpl(
	    "http://rdfs.org/sioc/ns#Post", false);
     ...
     */
    protected Post(Model model, URI classURI,
     ...
     */
    public Post(Model model, String uriString, boolean write)
	    throws ModelRuntimeException {
     ...
     */
    public static Post getInstance(Model model,
     ...
     * statement (instanceResource, RDF.type, http://rdfs.org/sioc/ns#Post).
     * 
     * @param model
     *            an RDF2Go model
     * @param instanceResource
