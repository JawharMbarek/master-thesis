...
public interface Item extends SIOCGlobal {
     ...
     */
    @Iri( "http://rdfs.org/sioc/ns#about" )
    void setSiocAbout( Set<?> siocAbout );
    ...
    Set<Object> getSiocAttachment();

    /** The URI of a file attached to an Item. */
    @Iri( "http://rdfs.org/sioc/ns#attachment" )
    void setSiocAttachment( Set<?> siocAttachment );

    /** The content of the Item in plain text format. */
    @Iri( "http://rdfs.org/sioc/ns#content" )
    Set<Object> getSiocContent();

    /** The content of the Item in plain text format. */
    @Iri( "http://rdfs.org/sioc/ns#content" )
    void setSiocContent( Set<?> siocContent );
    ...
    Set<Container> getSiocHas_container();

    /** The Container to which this Item belongs. */
    @Iri( "http://rdfs.org/sioc/ns#has_container" )
    void setSiocHas_container( Set<? extends Container> siocHas_container );
    ...
    Set<Item> getSiocNext_by_date();

    /** Next Item or Post in a given Container sorted by date. */
    @Iri( "http://rdfs.org/sioc/ns#next_by_date" )
    void setSiocNext_by_date( Set<? extends Item> siocNext_by_date );
    ...
    Set<Item> getSiocPrevious_by_date();

    /** Previous Item or Post in a given Container sorted by date. */
    @Iri( "http://rdfs.org/sioc/ns#previous_by_date" )
    void setSiocPrevious_by_date( Set<? extends Item> siocPrevious_by_date );
     ...
     */
    @Iri( "http://rdfs.org/sioc/ns#sibling" )
    void setSiocSibling( Set<? extends Item> siocSibling );
