...
/**
 * Basic interface of a Class the handles API clients for a connector.
 * 
 * @author "Florian Mueller"
 * 
 * @param <T>
 *            Class of the API client
 */
public interface IClientManager<T> {
	...
	/**
	 * Clears the {@link IClientManager} and frees all allocated resources.
	 */
	public void clear();
}
