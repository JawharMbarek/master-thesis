...
public final class CanvasLmsSiocUtils {
    ...
    public static boolean isDiscussionTopicUri(final URI uri,
            final URI serviceEndpoint) {
        Pattern pattern = Pattern.compile(serviceEndpoint
                + REGEX_DISCUSSION_TOPIC_URI + "$");
        Matcher matcher = pattern.matcher(uri.toString());
    ...
    public static boolean isInitialEntryUri(final URI uri,
            final URI serviceEndpoint) {
        Pattern pattern = Pattern.compile(serviceEndpoint
                + REGEX_INITIAL_ENTRY_URI + "$");
        Matcher matcher = pattern.matcher(uri.toString());
