...
public class FacebookToSIOCConverter {
     ...
     */
    public static Post createPostFromJSON(final FacebookConnector connector,
     ...
     *             Thrown if one or more parameters are null
     */
    public static Post createCommentPostFromJSON(
     ...
     *             Thrown if one or more parameters are null
     */
    public static Forum createForumFromGroup(final FacebookConnector connector,
     ...
     *             Thrown if one or more parameters are null
     */
    public static UserAccount createUserAccountFromUser(
