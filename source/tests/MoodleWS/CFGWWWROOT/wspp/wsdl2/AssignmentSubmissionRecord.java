...
public class AssignmentSubmissionRecord  extends SoapObject  implements Soapeabilisable{
    ...
    private CFGWWWROOT/wspp/wsdl2.FileRecord[] files;
     ...
     * @return files
     */
    public CFGWWWROOT/wspp/wsdl2.FileRecord[] getFiles() {
        return files;
    }
     ...
     * @param files
     */
    public void setFiles(CFGWWWROOT/wspp/wsdl2.FileRecord[] files) {
        this.files = files;
