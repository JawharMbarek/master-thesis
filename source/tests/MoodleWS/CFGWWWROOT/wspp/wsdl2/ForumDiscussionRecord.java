...
public class ForumDiscussionRecord  extends SoapObject  implements Soapeabilisable{
    ...
    private CFGWWWROOT/wspp/wsdl2.ForumPostRecord post;
    ...
    public Soapeabilisable fromSoapResponse (SoapObject response) {
      ...
      ret.setName(KSoap2Utils.getString(response,"name") );
       CFGWWWROOT/wspp/wsdl2.ForumPostRecord _post= (CFGWWWROOT/wspp/wsdl2.ForumPostRecord) (KSoap2Utils.getObject((SoapObject) response.getProperty("post"), new CFGWWWROOT/wspp/wsdl2.ForumPostRecord(this.namespace)));
       ret.setPost(_post);
     ...
     * @return post
     */
    public CFGWWWROOT/wspp/wsdl2.ForumPostRecord getPost() {
        return post;
    }
     ...
     * @param post
     */
    public void setPost(CFGWWWROOT/wspp/wsdl2.ForumPostRecord post) {
        this.post = post;
