...
/**
 * Vocabulary File. Created by org.ontoware.rdf2go.util.VocabularyWriter on Sun Dec 23 16:39:20 CET 2012
 * input file: src/main/resources/ontologies/sioc.rdf
 * namespace: http://rdfs.org/sioc/ns#
 */
public interface SIOC {
	public static final URI NS_SIOC = new URIImpl("http://rdfs.org/sioc/ns#",false);

    /**
     * Label: Community@en 
     * Comment: Community is a high-level concept that defines an online community and what it consists of.@en 
     */
    public static final URI Community = new URIImpl("http://rdfs.org/sioc/ns#Community", false);

    /**
     * Label: Container@en 
     * Comment: An area in which content Items are contained.@en 
     */
    public static final URI Container = new URIImpl("http://rdfs.org/sioc/ns#Container", false);

    /**
     * Label: Forum@en 
     * Comment: A discussion area on which Posts or entries are made.@en 
     */
    public static final URI Forum = new URIImpl("http://rdfs.org/sioc/ns#Forum", false);

    /**
     * Label: Item@en 
     * Comment: An Item is something which can be in a Container.@en 
     */
    public static final URI Item = new URIImpl("http://rdfs.org/sioc/ns#Item", false);

    /**
     * Label: Post@en 
     * Comment: An article or message that can be posted to a Forum.@en 
     */
    public static final URI Post = new URIImpl("http://rdfs.org/sioc/ns#Post", false);

    /**
     * Label: Role@en 
     * Comment: A Role is a function of a UserAccount within a scope of a particular Forum, Site, etc.@en 
     */
    public static final URI Role = new URIImpl("http://rdfs.org/sioc/ns#Role", false);

    /**
     * Label: Space@en 
     * Comment: A Space is a place where data resides, e.g. on a website, desktop, fileshare, etc.@en 
     */
    public static final URI Space = new URIImpl("http://rdfs.org/sioc/ns#Space", false);
     ...
     */
    public static final URI Site = new URIImpl("http://rdfs.org/sioc/ns#Site", false);

    /**
     * Label: Thread@en 
     * Comment: A container for a series of threaded discussion Posts or Items.@en 
     */
    public static final URI Thread = new URIImpl("http://rdfs.org/sioc/ns#Thread", false);

    /**
     * Label: User Account@en 
     * Comment: A user account in an online community site.@en 
     */
    public static final URI UserAccount = new URIImpl("http://rdfs.org/sioc/ns#UserAccount", false);

    /**
     * Label: Usergroup@en 
     * Comment: A set of UserAccounts whose owners have a common purpose or interest. Can be used for access control purposes.@en 
     */
    public static final URI Usergroup = new URIImpl("http://rdfs.org/sioc/ns#Usergroup", false);
     ...
     * Range: http://www.w3.org/2000/01/rdf-schema#Literal 
     */
    public static final URI email_sha1 = new URIImpl("http://rdfs.org/sioc/ns#email_sha1", false);
     ...
     * Range: http://www.w3.org/2000/01/rdf-schema#Literal 
     */
    public static final URI ip_address = new URIImpl("http://rdfs.org/sioc/ns#ip_address", false);
     ...
     * Range: http://www.w3.org/2000/01/rdf-schema#Literal 
     */
    public static final URI last_activity_date = new URIImpl("http://rdfs.org/sioc/ns#last_activity_date", false);
     ...
     * Comment: http://rdfs.org/sioc/ns#Container 
     * Range: http://www.w3.org/2000/01/rdf-schema#Literal 
     */
    public static final URI last_item_date = new URIImpl("http://rdfs.org/sioc/ns#last_item_date", false);
     ...
     * Range: http://www.w3.org/2000/01/rdf-schema#Literal 
     */
    public static final URI last_reply_date = new URIImpl("http://rdfs.org/sioc/ns#last_reply_date", false);
     ...
     */
    public static final URI num_authors = new URIImpl("http://rdfs.org/sioc/ns#num_authors", false);
     ...
     * Range: http://www.w3.org/2001/XMLSchema#nonNegativeInteger 
     */
    public static final URI num_items = new URIImpl("http://rdfs.org/sioc/ns#num_items", false);
     ...
     * Range: http://www.w3.org/2001/XMLSchema#nonNegativeInteger 
     */
    public static final URI num_replies = new URIImpl("http://rdfs.org/sioc/ns#num_replies", false);

    /**
     * Label: num threads@en 
     * Comment: The number of Threads (AKA discussion topics) in a Forum.@en 
     * Comment: http://rdfs.org/sioc/ns#Forum 
     * Range: http://www.w3.org/2001/XMLSchema#nonNegativeInteger 
     */
    public static final URI num_threads = new URIImpl("http://rdfs.org/sioc/ns#num_threads", false);
     ...
     * Range: http://www.w3.org/2001/XMLSchema#nonNegativeInteger 
     */
    public static final URI num_views = new URIImpl("http://rdfs.org/sioc/ns#num_views", false);
     ...
     */
    public static final URI account_of = new URIImpl("http://rdfs.org/sioc/ns#account_of", false);
     ...
     * Comment: http://rdfs.org/sioc/ns#Item 
     */
    public static final URI addressed_to = new URIImpl("http://rdfs.org/sioc/ns#addressed_to", false);
     ...
     */
    public static final URI administrator_of = new URIImpl("http://rdfs.org/sioc/ns#administrator_of", false);
     ...
     */
    public static final URI container_of = new URIImpl("http://rdfs.org/sioc/ns#container_of", false);
     ...
     * Comment: http://rdfs.org/sioc/ns#UserAccount 
     */
    public static final URI creator_of = new URIImpl("http://rdfs.org/sioc/ns#creator_of", false);
     ...
     */
    public static final URI embeds_knowledge = new URIImpl("http://rdfs.org/sioc/ns#embeds_knowledge", false);
     ...
     */
    public static final URI function_of = new URIImpl("http://rdfs.org/sioc/ns#function_of", false);

    /**
     * Label: has administrator@en 
     * Comment: A UserAccount that is an administrator of this Site.@en 
     * Comment: http://rdfs.org/sioc/ns#Site 
     * Range: http://rdfs.org/sioc/ns#UserAccount 
     */
    public static final URI has_administrator = new URIImpl("http://rdfs.org/sioc/ns#has_administrator", false);
     ...
     */
    public static final URI has_container = new URIImpl("http://rdfs.org/sioc/ns#has_container", false);
     ...
     * Range: http://rdfs.org/sioc/ns#UserAccount 
     */
    public static final URI has_creator = new URIImpl("http://rdfs.org/sioc/ns#has_creator", false);
     ...
     * Comment: http://rdfs.org/sioc/ns#Item 
     */
    public static final URI has_discussion = new URIImpl("http://rdfs.org/sioc/ns#has_discussion", false);
     ...
     */
    public static final URI has_function = new URIImpl("http://rdfs.org/sioc/ns#has_function", false);
     ...
     * Range: http://rdfs.org/sioc/ns#Site 
     */
    public static final URI has_host = new URIImpl("http://rdfs.org/sioc/ns#has_host", false);

    /**
     * Label: has member@en 
     * Comment: A UserAccount that is a member of this Usergroup.@en 
     * Comment: http://rdfs.org/sioc/ns#Usergroup 
     * Range: http://rdfs.org/sioc/ns#UserAccount 
     */
    public static final URI has_member = new URIImpl("http://rdfs.org/sioc/ns#has_member", false);
     ...
     * Range: http://rdfs.org/sioc/ns#UserAccount 
     */
    public static final URI has_moderator = new URIImpl("http://rdfs.org/sioc/ns#has_moderator", false);
     ...
     * Range: http://rdfs.org/sioc/ns#UserAccount 
     */
    public static final URI has_modifier = new URIImpl("http://rdfs.org/sioc/ns#has_modifier", false);
     ...
     * Range: http://rdfs.org/sioc/ns#UserAccount 
     */
    public static final URI has_owner = new URIImpl("http://rdfs.org/sioc/ns#has_owner", false);
     ...
     * Range: http://rdfs.org/sioc/ns#Container 
     */
    public static final URI has_parent = new URIImpl("http://rdfs.org/sioc/ns#has_parent", false);
     ...
     * Range: http://rdfs.org/sioc/ns#Item 
     */
    public static final URI has_reply = new URIImpl("http://rdfs.org/sioc/ns#has_reply", false);
     ...
     * Comment: http://rdfs.org/sioc/ns#Role 
     */
    public static final URI has_scope = new URIImpl("http://rdfs.org/sioc/ns#has_scope", false);
     ...
     */
    public static final URI has_space = new URIImpl("http://rdfs.org/sioc/ns#has_space", false);
     ...
     * Range: http://rdfs.org/sioc/ns#UserAccount 
     */
    public static final URI has_subscriber = new URIImpl("http://rdfs.org/sioc/ns#has_subscriber", false);
     ...
     */
    public static final URI has_usergroup = new URIImpl("http://rdfs.org/sioc/ns#has_usergroup", false);
     ...
     */
    public static final URI host_of = new URIImpl("http://rdfs.org/sioc/ns#host_of", false);
     ...
     * Range: http://rdfs.org/sioc/ns#Item 
     */
    public static final URI latest_version = new URIImpl("http://rdfs.org/sioc/ns#latest_version", false);
     ...
     */
    public static final URI links_to = new URIImpl("http://rdfs.org/sioc/ns#links_to", false);
     ...
     * Range: http://rdfs.org/sioc/ns#Usergroup 
     */
    public static final URI member_of = new URIImpl("http://rdfs.org/sioc/ns#member_of", false);
     ...
     * Range: http://rdfs.org/sioc/ns#Forum 
     */
    public static final URI moderator_of = new URIImpl("http://rdfs.org/sioc/ns#moderator_of", false);
     ...
     * Range: http://rdfs.org/sioc/ns#Item 
     */
    public static final URI modifier_of = new URIImpl("http://rdfs.org/sioc/ns#modifier_of", false);
     ...
     * Range: http://rdfs.org/sioc/ns#Item 
     */
    public static final URI next_by_date = new URIImpl("http://rdfs.org/sioc/ns#next_by_date", false);
     ...
     * Range: http://rdfs.org/sioc/ns#Item 
     */
    public static final URI next_version = new URIImpl("http://rdfs.org/sioc/ns#next_version", false);
     ...
     * Comment: http://rdfs.org/sioc/ns#UserAccount 
     */
    public static final URI owner_of = new URIImpl("http://rdfs.org/sioc/ns#owner_of", false);
     ...
     * Range: http://rdfs.org/sioc/ns#Container 
     */
    public static final URI parent_of = new URIImpl("http://rdfs.org/sioc/ns#parent_of", false);
     ...
     * Range: http://rdfs.org/sioc/ns#Item 
     */
    public static final URI previous_by_date = new URIImpl("http://rdfs.org/sioc/ns#previous_by_date", false);
     ...
     * Range: http://rdfs.org/sioc/ns#Item 
     */
    public static final URI previous_version = new URIImpl("http://rdfs.org/sioc/ns#previous_version", false);

    /**
     * Label: related to@en 
     * Comment: Related Posts for this Post, perhaps determined implicitly from topics or references.@en 
     */
    public static final URI related_to = new URIImpl("http://rdfs.org/sioc/ns#related_to", false);
     ...
     * Range: http://rdfs.org/sioc/ns#Item 
     */
    public static final URI reply_of = new URIImpl("http://rdfs.org/sioc/ns#reply_of", false);
     ...
     * Range: http://rdfs.org/sioc/ns#Role 
     */
    public static final URI scope_of = new URIImpl("http://rdfs.org/sioc/ns#scope_of", false);
     ...
     * Comment: http://rdfs.org/sioc/ns#Space 
     */
    public static final URI space_of = new URIImpl("http://rdfs.org/sioc/ns#space_of", false);
     ...
     * Range: http://rdfs.org/sioc/ns#Container 
     */
    public static final URI subscriber_of = new URIImpl("http://rdfs.org/sioc/ns#subscriber_of", false);
     ...
     * Range: http://rdfs.org/sioc/ns#Space 
     */
    public static final URI usergroup_of = new URIImpl("http://rdfs.org/sioc/ns#usergroup_of", false);
