...
public class AssignmentSubmissionRecord  extends SoapObject  implements Soapeabilisable{
    ...
    private localhost.florian.moodle24.wspp.wsdl2.FileRecord[] files;
     ...
     * @return files
     */
    public localhost.florian.moodle24.wspp.wsdl2.FileRecord[] getFiles() {
        return files;
    }
     ...
     * @param files
     */
    public void setFiles(localhost.florian.moodle24.wspp.wsdl2.FileRecord[] files) {
        this.files = files;
