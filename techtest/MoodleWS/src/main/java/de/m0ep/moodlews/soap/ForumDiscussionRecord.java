...
public class ForumDiscussionRecord  extends SoapObject  implements Soapeabilisable{
    ...
    private de.m0ep.moodlews.soap.ForumPostRecord post;
    ...
    public Soapeabilisable fromSoapResponse (SoapObject response) {
      ...
      ret.setName(KSoap2Utils.getString(response,"name") );
       de.m0ep.moodlews.soap.ForumPostRecord _post= (de.m0ep.moodlews.soap.ForumPostRecord) (KSoap2Utils.getObject((SoapObject) response.getProperty("post"), new de.m0ep.moodlews.soap.ForumPostRecord(this.namespace)));
       ret.setPost(_post);
     ...
     * @return post
     */
    public de.m0ep.moodlews.soap.ForumPostRecord getPost() {
        return post;
    }
     ...
     * @param post
     */
    public void setPost(de.m0ep.moodlews.soap.ForumPostRecord post) {
        this.post = post;
