...
\begin{itemize}
    \item SIOC als geeignetes Zwischenformat
    \item warum Ontologie und keine neues XML Schema!?
\end{itemize}

% subsection welches_zwischenformat (end)

\subsection{Nachrichtensystem} % (fold)
\label{sub:nachrichtensystem}
...
\subsection{JMS + Apache Camel} % (fold)
\label{sub:jms_apache_camel}

\begin{itemize}
    \item gute kombination -> durable subscriber
\end{itemize}

% subsection jms_apache_camel (end)

% subsubsection apache_camel (end)

% subsubsection jms (end)

% subsection nachrichtensystem (end)
