...
Dieser Abschnitt widmet sich den internen Aufbau eines Connectors und beschreibt alle Komponenten aus denen er besteht und wie sie zusammenarbeiten. Im einzelnen sind dies der \texttt{SOCC Context}, die \emph{AccessControl}, der \texttt{ClientManager}, der \emph{StructureReader}, der \emph{PostReader} und der \emph{PostWriter}. Das vollständige UML Klassendiagramm mit allen Zusammenhängen ist in Abbildung \ref{fig:connector_uml_classdiagram} zu sehen.
