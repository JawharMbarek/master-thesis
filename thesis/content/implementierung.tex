...
In den folgenden Abschnitten wird erklärt wie man auf die Daten der einzelnen Plattformen über ihre APIs zugreifen kann und welche Voraussetzungen dafür erfüllt sein müssen. Gleichfalls wird beschreiben, wie der Zugriff auf diese API innerhalb der Programmiersprache  Java geschehen kann, da diese APIs in der Regel für Webanwendungen ausgelegt sind. Danach wird noch gezeigt welches Mapping zwischen den Ressource der Plattformen und dem SIOC-Format gewählt wurde. Traten bei der Implementierung Besonderheiten auf, die für andere Entwickler interessant sein könnten, wurden diese in einen eigenen Abschnitt des betreffenden Connectors aufgeführt.
...
%\todo[inline]{Auf die verschiedenen Klassen von Facebook und Co eingehen, REST, SOAP, OAUTH, Client/Passwort, Art der Plattform, Forum, OSN, Videoplatform}
...
\begin{table}[ht]
    ...
    \begin{tabular}{l|p{11cm}}
        ...
        \hline
        \texttt{\{rootUri\}} & Die Basis-URI einer Webseite (Schema + Authority\footnote{\url{http://tools.ietf.org/html/rfc3986\#section-3}}). Für Facebook wäre dies zum Beispiel \texttt{https://www.facebook.com} \\
