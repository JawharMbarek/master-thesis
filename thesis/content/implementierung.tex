...
\todo[inline][Keine Schreiben mit fremden Benutzerkonnte auf die Wall eines Benutzers]
...
Vor den Start des Programm befinden sich in der Canvas Diskussion für die erste Gruppenübung schon zwei Beiträge, wie in der rechten Abbildung \ref{fig:poc_ausgangssituation} zu sehen ist. Der Benutzer Florian stellt eine Frage und diese wird von Max Hiwi mit einer Gegenfrage kommentiert. Der Beitrag auf Facebook ist dagegen noch leer (Hier nicht abgebildet).
...
\begin{wrapfigure}[19]{r}{11cm}
    ...
    \includegraphics[
        width=11cm,
        keepaspectratio=true,]
    {assets/images/poc/1_facebook_blurred}
