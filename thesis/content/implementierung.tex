...
Das Listing \ref{lst:gplus_activity_feed_java} ist eine kleines Beispiel wie auf den Activity-Feed, also die Liste der geschriebenen Beiträge eines Benutzer, in Google+ mit der Java-Bibliothek zugegriffen werden kann. 
